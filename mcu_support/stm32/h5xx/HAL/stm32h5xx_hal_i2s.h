...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            Data24BitAlignment; /*!< Specifies the Data Padding for 24 bits data length
  ...
  */
    ...
    {
        HAL_I2S_STATE_RESET =
            0x00UL, /*!< I2S not yet initialized or disabled                */
        HAL_I2S_STATE_READY =
            0x01UL, /*!< I2S initialized and ready for use                  */
        HAL_I2S_STATE_BUSY =
            0x02UL, /*!< I2S internal process is ongoing                    */
        ...
        HAL_I2S_STATE_TIMEOUT =
            0x06UL, /*!< I2S timeout state                                  */
        HAL_I2S_STATE_ERROR =
            0x07UL /*!< I2S error state                                    */
  ...
  */
    typedef struct __I2S_HandleTypeDef
    {
        ...
        void (*RxISR)(struct __I2S_HandleTypeDef*
                          hi2s); /*!< function pointer on Rx ISR */

        void (*TxISR)(struct __I2S_HandleTypeDef*
                          hi2s); /*!< function pointer on Tx ISR */
        ...
        void (*TxRxCpltCallback)(
            struct __I2S_HandleTypeDef*
                hi2s); /*!< I2S TxRx Completed callback        */
  ...
  */
    typedef enum
    {
        HAL_I2S_TX_COMPLETE_CB_ID =
            0x00UL, /*!< I2S Tx Completed callback ID         */
        HAL_I2S_RX_COMPLETE_CB_ID =
            0x01UL, /*!< I2S Rx Completed callback ID         */
        HAL_I2S_TX_RX_COMPLETE_CB_ID =
            0x02UL, /*!< I2S TxRx Completed callback ID       */
        ...
        HAL_I2S_ERROR_CB_ID =
            0x06UL, /*!< I2S Error callback ID                */
        HAL_I2S_MSPINIT_CB_ID =
            0x07UL, /*!< I2S Msp Init callback ID             */
        HAL_I2S_MSPDEINIT_CB_ID =
            0x08UL /*!< I2S Msp DeInit callback ID           */
