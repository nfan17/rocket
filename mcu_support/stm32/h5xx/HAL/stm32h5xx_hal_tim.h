...
#define TIM_ENCODERMODE_DIRECTIONALCLOCK_X1_TI12 \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 |           \
     TIM_SMCR_SMS_0) /*!< Encoder mode: Directional Clock, x1 mode, TI1FP1 and TI2FP2 edge sensitivity is set by CC1P and CC2P */
#define TIM_ENCODERMODE_X1_TI1         \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 | \
     TIM_SMCR_SMS_1) /*!< Quadrature encoder mode: x1 mode, counting on TI1FP1 edges only, edge sensitivity is set by CC1P */
#define TIM_ENCODERMODE_X1_TI2                          \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 | \
     TIM_SMCR_SMS_0) /*!< Quadrature encoder mode: x1 mode, counting on TI2FP2 edges only, edge sensitivity is set by CC1P */
/**
  * @}
  */
...
#define TIM_TS_ITR5  \
    (TIM_SMCR_TS_0 | \
     TIM_SMCR_TS_3) /*!< Internal Trigger 5 (ITR5)              */
#define TIM_TS_ITR6  \
    (TIM_SMCR_TS_1 | \
     TIM_SMCR_TS_3) /*!< Internal Trigger 6 (ITR6)              */
#define TIM_TS_ITR7                  \
    (TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | \
     TIM_SMCR_TS_3) /*!< Internal Trigger 7 (ITR7)              */
#define TIM_TS_ITR8  \
    (TIM_SMCR_TS_2 | \
     TIM_SMCR_TS_3) /*!< Internal Trigger 8 (ITR8)              */
#define TIM_TS_ITR9                  \
...
#define TIM_BREAK_SYSTEM_ECC \
    SBS_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_PVD \
    SBS_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17/20 Break Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR \
    SBS_CFGR2_SEL /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_LOCKUP \
    SBS_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/8/15/16/17/20 */
/**
  * @}
  */
