...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            Blanking; /*!< Specifies whether or not the encoder index event is conditioned by TI3 or TI4 input.This parameter can be a value of @ref TIMEx_Encoder_Index_Blanking */
...
#define TIM_TIM2_ETR_LSE \
    (TIM1_AF1_ETRSEL_0 | \
     TIM1_AF1_ETRSEL_1) /*!< TIM2_ETR is connected to LSE          */
#if defined(SAI1)
#define TIM_TIM2_ETR_SAI1_FSA \
    TIM1_AF1_ETRSEL_2 /*!< TIM2_ETR is connected to SAI1 FS_A    */
#define TIM_TIM2_ETR_SAI1_FSB \
    (TIM1_AF1_ETRSEL_0 |      \
     TIM1_AF1_ETRSEL_2) /*!< TIM2_ETR is connected to SAI1         */
#endif                  /* SAI1 */
#define TIM_TIM2_ETR_TIM3_ETR \
    (TIM1_AF1_ETRSEL_0 |      \
     TIM1_AF1_ETRSEL_3) /*!< TIM2_ETR is connected to TIM3 ETR     */
#if defined(TIM4)
#define TIM_TIM2_ETR_TIM4_ETR \
    (TIM1_AF1_ETRSEL_1 |      \
     TIM1_AF1_ETRSEL_3) /*!< TIM2_ETR is connected to TIM4 ETR     */
#endif                  /* TIM4 */
#if defined(TIM5)
#define TIM_TIM2_ETR_TIM5_ETR                \
    (TIM1_AF1_ETRSEL_0 | TIM1_AF1_ETRSEL_1 | \
     TIM1_AF1_ETRSEL_3) /*!< TIM2_ETR is connected to TIM5 ETR     */
#endif                  /* TIM5 */
#if defined(ETH_NS)
#define TIM_TIM2_ETR_ETH_PPS                 \
    (TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_2 | \
     TIM1_AF1_ETRSEL_3) /*!< TIM2_ETR is connected to ETH PPS      */
#endif                  /* ETH_NS */
...
#define IS_TIM_TRIGGER_INSTANCE(INSTANCE, __SELECTION__)                       \
    ((((INSTANCE) == TIM1) &&                                                  \
      (((__SELECTION__) == TIM_TS_TI1F_ED) ||                                  \
       ((__SELECTION__) == TIM_TS_TI1FP1) ||                                   \
       ((__SELECTION__) == TIM_TS_TI2FP2) ||                                   \
       ((__SELECTION__) == TIM_TS_ETRF) || ((__SELECTION__) == TIM_TS_ITR1) || \
     ...
     (((INSTANCE) == TIM2) &&                                                  \
      (((__SELECTION__) == TIM_TS_TI1F_ED) ||                                  \
       ((__SELECTION__) == TIM_TS_TI1FP1) ||                                   \
       ((__SELECTION__) == TIM_TS_TI2FP2) ||                                   \
       ((__SELECTION__) == TIM_TS_ETRF) || ((__SELECTION__) == TIM_TS_ITR0) || \
       ((__SELECTION__) == TIM_TS_ITR2) || ((__SELECTION__) == TIM_TS_ITR3) || \
       ((__SELECTION__) == TIM_TS_ITR4) || ((__SELECTION__) == TIM_TS_ITR5) || \
       ((__SELECTION__) == TIM_TS_ITR6) || ((__SELECTION__) == TIM_TS_ITR7) || \
       ((__SELECTION__) == TIM_TS_ITR8) || ((__SELECTION__) == TIM_TS_ITR9) || \
     ...
     (((INSTANCE) == TIM3) &&                                                  \
      (((__SELECTION__) == TIM_TS_TI1F_ED) ||                                  \
       ...
       ((__SELECTION__) == TIM_TS_TI2FP2) ||                                   \
       ((__SELECTION__) == TIM_TS_ETRF) || ((__SELECTION__) == TIM_TS_ITR0) || \
       ((__SELECTION__) == TIM_TS_ITR1) || ((__SELECTION__) == TIM_TS_ITR3) || \
       ((__SELECTION__) == TIM_TS_ITR4) || ((__SELECTION__) == TIM_TS_ITR5) || \
       ((__SELECTION__) == TIM_TS_ITR6) || ((__SELECTION__) == TIM_TS_ITR7) || \
       ((__SELECTION__) == TIM_TS_ITR8) || ((__SELECTION__) == TIM_TS_ITR9) || \
       ((__SELECTION__) == TIM_TS_ITR10) ||                                    \
