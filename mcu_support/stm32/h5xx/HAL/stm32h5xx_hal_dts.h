...
#include "stm32h5xx_hal_def.h"
  ...
  */
    ...
    {
        uint32_t
            QuickMeasure; /*!< Specifies the quick measure option selection of the DTS sensor.
                               This parameter can be a value of @ref DTS_Quick_Measurement         */

        uint32_t
            RefClock; /*!< Specifies the reference clock selection of the DTS sensor.
                               This parameter can be a value of @ref DTS_Reference_Clock_Selection */

        uint32_t
            TriggerInput; /*!< Specifies the trigger input of the DTS sensor.
        ...
        uint32_t
            HighThreshold; /*!< Specifies the high threshold of the DTS sensor                      */

        uint32_t
            LowThreshold; /*!< Specifies the low threshold of the DTS sensor                       */
  ...
  */
    ...
    {
        HAL_DTS_STATE_RESET =
            0x00UL, /*!< DTS not yet initialized or disabled */
        HAL_DTS_STATE_READY =
            0x01UL,                  /*!< DTS initialized and ready for use   */
        HAL_DTS_STATE_BUSY = 0x02UL, /*!< DTS is running                      */
        HAL_DTS_STATE_TIMEOUT =
            0x03UL,                  /*!< Timeout state                       */
...
/**
  ...
  */
...
#endif /* USE_HAL_DTS_REGISTER_CALLBACKS */
    {
        ...
        __IO HAL_DTS_StateTypeDef
            State; /*!< DTS peripheral state                       */

#if (USE_HAL_DTS_REGISTER_CALLBACKS == 1U)
        void (*MspInitCallback)(
            struct __DTS_HandleTypeDef*
                hdts); /*!< DTS Base Msp Init Callback                 */
        void (*MspDeInitCallback)(
            struct __DTS_HandleTypeDef*
                hdts); /*!< DTS Base Msp DeInit Callback               */
        void (*EndCallback)(
            struct __DTS_HandleTypeDef*
                hdts); /*!< End measure Callback                       */
        void (*LowCallback)(
            struct __DTS_HandleTypeDef*
                hdts); /*!< low threshold Callback                     */
        void (*HighCallback)(
            struct __DTS_HandleTypeDef*
                hdts); /*!< high threshold Callback                    */
  ...
  */
    typedef enum
    {
        HAL_DTS_MEAS_COMPLETE_CB_ID =
            0x00U, /*!< Measure complete callback ID */
...
#define __HAL_DTS_GET_TRIGGER(__HANDLE__) \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_DTS_RegisterCallback(
        DTS_HandleTypeDef* hdts, HAL_DTS_CallbackIDTypeDef CallbackID,
        pDTS_CallbackTypeDef pCallback);
    HAL_StatusTypeDef HAL_DTS_UnRegisterCallback(
        DTS_HandleTypeDef* hdts, HAL_DTS_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_DTS_REGISTER_CALLBACKS */
    /**
  * @}
