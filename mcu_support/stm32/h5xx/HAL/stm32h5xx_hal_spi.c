...
HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef* hspi)
{
    ...
    assert_param(
        IS_SPI_RDY_MASTER_MANAGEMENT(hspi->Init.ReadyMasterManagement));
    ...
    SPI_HandleTypeDef* hspi, HAL_SPI_CallbackIDTypeDef CallbackID)
{
    ...
    if (HAL_SPI_STATE_READY == hspi->State)
    {
        switch (CallbackID)
        {
            ...
            case HAL_SPI_MSPINIT_CB_ID:
                hspi->MspInitCallback =
                    HAL_SPI_MspInit; /* Legacy weak MspInit              */
                break;
                                      ...
                                      const uint8_t* pData, uint16_t Size)
{
    ...
    __HAL_SPI_ENABLE_IT(hspi, (SPI_IT_EOT | SPI_IT_TXP | SPI_IT_UDR |
                                     ...
                                     uint16_t Size)
{
    ...
    __HAL_SPI_ENABLE_IT(hspi, (SPI_IT_EOT | SPI_IT_RXP | SPI_IT_OVR |
                               SPI_IT_FRE | SPI_IT_MODF));
                                             ...
                                             uint8_t* pRxData, uint16_t Size)
{
    ...
    __HAL_SPI_ENABLE_IT(hspi, (SPI_IT_EOT | SPI_IT_DXP | SPI_IT_UDR |
         ...
         (SPI_FLAG_MODF | SPI_FLAG_OVR | SPI_FLAG_FRE | SPI_FLAG_UDR)) != 0UL)
    {
        ...
        if (hspi->ErrorCode != HAL_SPI_ERROR_NONE)
        {
            ...
            __HAL_SPI_DISABLE_IT(
                hspi, (SPI_IT_EOT | SPI_IT_RXP | SPI_IT_TXP | SPI_IT_MODF |
...
static void SPI_AbortTransfer(SPI_HandleTypeDef* hspi)
{
    ...
    /* Disable ITs */
    __HAL_SPI_DISABLE_IT(
        hspi, (SPI_IT_EOT | SPI_IT_TXP | SPI_IT_RXP | SPI_IT_DXP | SPI_IT_UDR |
               SPI_IT_OVR | SPI_IT_FRE | SPI_IT_MODF));
