...
#define ETH_MAC_US_TICK 1000000U
  ...
  */
    typedef struct
    {
        ...
        uint32_t* PacketAddress
            [ETH_TX_DESC_CNT]; /*<! Ethernet packet addresses array */

        uint32_t*
            CurrentPacketAddress; /*<! Current transmit NX_PACKET addresses */
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            MaxSegmentSize; /*!< Sets TCP maximum segment size only when TCP segmentation is enabled.
                                        This parameter can be a value from 0x0 to 0x3FFF */

        uint32_t
            PayloadLen; /*!< Sets Total payload length only when TCP segmentation is enabled.
                                        This parameter can be a value from 0x0 to 0x3FFFF */

        uint32_t
            TCPHeaderLen; /*!< Sets TCP header length only when TCP segmentation is enabled.
        ...
        uint32_t
            VlanCtrl; /*!< Specifies VLAN Tag insertion control only when VLAN is enabled.
        ...
        uint32_t
            InnerVlanCtrl; /*!< Specifies Inner VLAN Tag insertion control only when Inner VLAN is enabled.
...
/**
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            RxBuildDescCnt; /*<! Number of Rx Descriptors awaiting building. */

        uint32_t pRxLastRxDesc; /*<! Last received descriptor. */

        ETH_TimeStampTypeDef
            TimeStamp; /*<! Time Stamp Low value for receive. */
  ...
  */
    typedef struct
    {
        ...
        FunctionalState
            GiantPacketSizeLimitControl; /*!< Enables or disables the Giant Packet Size Limit Control. */
        ...
        FunctionalState
            LoopbackMode; /*!< Enables or disables the loopback mode */

        FunctionalState
            CarrierSenseBeforeTransmit; /*!< Enables or disables the Carrier Sense Before Transmission in Full Duplex Mode. */

        FunctionalState
            ReceiveOwn; /*!< Enables or disables the Receive Own in Half Duplex mode. */
        ...
        FunctionalState
            SlowProtocolDetect; /*!< Enable or disables the Slow Protocol Detection. */
        ...
        uint32_t
            TransmitQueueMode; /*!< Specifies the Transmit Queue operating mode.
        ...
        FunctionalState
            ForwardRxUndersizedGoodPacket; /*!< Enables or disables  forwarding Undersized Good Packets.*/
  ...
  */
    typedef struct
    {
        ...
        FunctionalState
            RebuildINCRxBurst; /*!< Enables or disables the AHB Master to rebuild the pending beats
  ...
  */
    ...
    {
        HAL_ETH_MII_MODE =
            0x00U, /*!<  Media Independent Interface               */
        HAL_ETH_RMII_MODE =
            0x01U /*!<   Reduced Media Independent Interface       */
  ...
  */
    typedef enum
    {
        HAL_ETH_PTP_POSITIVE_UPDATE =
            0x00000000U, /*!<  PTP positive time update       */
        HAL_ETH_PTP_NEGATIVE_UPDATE =
            0x00000001U /*!<  PTP negative time update       */
...
/**
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            TimestampRolloverMode; /*!< Timestamp Digital or Binary Rollover Control */
        uint32_t
        ...
        uint32_t
            TimestampEvent; /*!< Enable Timestamp Snapshot for Event Messages */
        uint32_t
            TimestampMaster; /*!< Enable Timestamp Snapshot for Event Messages */
        uint32_t
            TimestampSnapshots; /*!< Select PTP packets for Taking Snapshots */
        uint32_t
            TimestampFilter; /*!< Enable MAC Address for PTP Packet Filtering */
        uint32_t
...
/**
  ...
  */
    typedef void (*pETH_txPtpCallbackTypeDef)(
        uint32_t* buffer,
        ETH_TimeStampTypeDef*
            timestamp); /*!< pointer to an ETH Tx Free function */
/**
  *
  */
...
/**
  ...
  */
...
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
    {
        ...
        __IO uint32_t
            MACWakeUpEvent; /*!< Holds the Wake Up event when the MAC exit the power down mode
        ...
        void (*RxCpltCallback)(struct __ETH_HandleTypeDef*
                                   heth); /*!< ETH Rx  Complete Callback     */
        void (*ErrorCallback)(
            struct __ETH_HandleTypeDef* heth); /*!< ETH Error Callback   */
        void (*PMTCallback)(
            struct __ETH_HandleTypeDef*
                heth); /*!< ETH Power Management Callback            */
        void (*EEECallback)(
        ...
        void (*MspInitCallback)(
            struct __ETH_HandleTypeDef*
                heth); /*!< ETH Msp Init callback              */
        void (*MspDeInitCallback)(
            struct __ETH_HandleTypeDef*
                heth); /*!< ETH Msp DeInit callback            */
        ...
        pETH_txFreeCallbackTypeDef
            txFreeCallback; /*!< ETH Tx Free Function         */
  ...
  */
    typedef enum
    {
        ...
        HAL_ETH_MSPDEINIT_CB_ID =
            0x01U, /*!< ETH MspDeInit callback ID         */
        HAL_ETH_TX_COMPLETE_CB_ID =
            0x02U, /*!< ETH Tx Complete Callback ID       */
        HAL_ETH_RX_COMPLETE_CB_ID =
            0x03U,                   /*!< ETH Rx Complete Callback ID       */
  ...
  */
    ...
    {
        FunctionalState
            PromiscuousMode; /*!< Enable or Disable Promiscuous Mode */

        FunctionalState
            ReceiveAllMode; /*!< Enable or Disable Receive All Mode */

        FunctionalState
            HachOrPerfectFilter; /*!< Enable or Disable Perfect filtering in addition to Hash filtering */

        FunctionalState
            HashUnicast; /*!< Enable or Disable Hash filtering on unicast packets */

        FunctionalState
            HashMulticast; /*!< Enable or Disable Hash filtering on multicast packets */

        FunctionalState
            PassAllMulticast; /*!< Enable or Disable passing all multicast packets */

        FunctionalState
            SrcAddrFiltering; /*!< Enable or Disable source address filtering module */
        ...
        FunctionalState
            BroadcastFilter; /*!< Enable or Disable broadcast filter */
...
#define ETH_DMATXNDESCWBF_ES \
    0x00008000U /*!< Error summary: OR of the following bits: IHE || UF || ED || EC || LCO || PCE || NC || LCA || FF || JT */
...
#define ETH_DMARXNDESCWBF_PMT_PDRESPFUP \
    0x00000700U /*!< PTP Message Type: Pdelay_Resp_Follow_Up (in peer-to-peer transparent clock)  */
...
#define ETH_DMARXNDESCWBF_L3L4FM \
    0x20000000U /*!< L3 and L4 Filter Number Matched: if reset filter 0 is matched , if set filter 1 is matched */
...
/* Callbacks Register/UnRegister functions  ***********************************/
    ...
    HAL_StatusTypeDef HAL_ETH_RegisterCallback(
        ETH_HandleTypeDef* heth, HAL_ETH_CallbackIDTypeDef CallbackID,
  ...
  */
    ...
    HAL_StatusTypeDef HAL_ETH_UnRegisterRxAllocateCallback(
        ETH_HandleTypeDef* heth);
    HAL_StatusTypeDef HAL_ETH_RegisterRxLinkCallback(
        ETH_HandleTypeDef* heth, pETH_rxLinkCallbackTypeDef rxLinkCallback);
    ...
    HAL_StatusTypeDef HAL_ETH_RegisterTxFreeCallback(
        ETH_HandleTypeDef* heth, pETH_txFreeCallbackTypeDef txFreeCallback);
    ...
    HAL_StatusTypeDef HAL_ETH_PTP_AddTimeOffset(
        ETH_HandleTypeDef* heth, ETH_PtpUpdateTypeDef ptpoffsettype,
        ETH_TimeTypeDef* timeoffset);
    HAL_StatusTypeDef HAL_ETH_PTP_InsertTxTimestamp(ETH_HandleTypeDef* heth);
    HAL_StatusTypeDef HAL_ETH_PTP_GetTxTimestamp(
        ETH_HandleTypeDef* heth, ETH_TimeStampTypeDef* timestamp);
    HAL_StatusTypeDef HAL_ETH_PTP_GetRxTimestamp(
        ETH_HandleTypeDef* heth, ETH_TimeStampTypeDef* timestamp);
    HAL_StatusTypeDef HAL_ETH_RegisterTxPtpCallback(
        ETH_HandleTypeDef* heth, pETH_txPtpCallbackTypeDef txPtpCallback);
  ...
  */
    ...
    HAL_StatusTypeDef HAL_ETH_GetMACFilterConfig(
        ETH_HandleTypeDef* heth, ETH_MACFilterConfigTypeDef* pFilterConfig);
