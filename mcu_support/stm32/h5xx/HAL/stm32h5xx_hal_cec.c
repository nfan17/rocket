...
HAL_StatusTypeDef HAL_CEC_Init(CEC_HandleTypeDef* hcec)
{
    ...
    hcec->Instance->CFGR =
        hcec->Init.SignalFreeTime | hcec->Init.Tolerance |
...
HAL_StatusTypeDef HAL_CEC_DeInit(CEC_HandleTypeDef* hcec)
{
    ...
    {
        hcec->MspDeInitCallback =
            HAL_CEC_MspDeInit; /* Legacy weak MspDeInit  */
    }
...
void HAL_CEC_IRQHandler(CEC_HandleTypeDef* hcec)
{
                   ...
                   CEC_ISR_TXACKE)) != 0U)
    {
        ...
        __HAL_CEC_CLEAR_FLAG(
            hcec, HAL_CEC_ERROR_RXOVR | HAL_CEC_ERROR_BRE | CEC_FLAG_LBPE |
                      CEC_FLAG_SBPE | HAL_CEC_ERROR_RXACKE |
                      HAL_CEC_ERROR_TXUDR | HAL_CEC_ERROR_TXERR |
                      HAL_CEC_ERROR_TXACKE);

        if ((itflag & (CEC_ISR_RXOVR | CEC_ISR_BRE | CEC_ISR_SBPE |
