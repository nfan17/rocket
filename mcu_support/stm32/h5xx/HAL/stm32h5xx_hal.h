...
#define SBS_EPOCH_SEL_NONSECURE \
    SBS_EPOCHSELCR_EPOCH_SEL_0 /*!< EPOCH non secure selected */
...
#define SBS_OBKHDPL_INCR_0 \
    0x00U /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next secure storage areas */
#define SBS_OBKHDPL_INCR_1 \
    SBS_NEXTHDPLCR_NEXTHDPL_0 /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next secure storage areas */
#define SBS_OBKHDPL_INCR_2 \
    SBS_NEXTHDPLCR_NEXTHDPL_1 /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next secure storage areas */
#define SBS_OBKHDPL_INCR_3 \
    SBS_NEXTHDPLCR_NEXTHDPL /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next secure storage areas */
/**
  * @}
  */
...
#define SBS_VTOR_AIRCR_SEC   \
    (SBS_CSLCKR_LOCKSVTAIRCR \
     << 16U) /*!< VTOR_S and AIRCR lock (privileged secure
                                                                          code only) */
#define SBS_LOCK_ALL                                        \
...
#define IS_SBS_BREAK_CONFIG(__CONFIG__)       \
    (((__CONFIG__) == SBS_BREAK_FLASH_ECC) || \
