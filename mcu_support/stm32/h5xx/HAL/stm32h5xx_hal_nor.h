...
#include "stm32h5xx_ll_fmc.h"
  ...
  */
    typedef enum
    {
        ...
        HAL_NOR_STATE_READY =
            0x01U,                  /*!< NOR initialized and ready for use    */
        HAL_NOR_STATE_BUSY = 0x02U, /*!< NOR internal processing is ongoing   */
        HAL_NOR_STATE_ERROR =
            0x03U, /*!< NOR error state                      */
  ...
  */
    ...
    {
        uint16_t
            Manufacturer_Code; /*!< Defines the device's manufacturer code used to identify the memory       */
        ...
        uint16_t
            Device_Code3; /*!< Defines the device's codes used to identify the memory.
...
/**
  ...
  */
...

    {
        ...
        HAL_LockTypeDef
            Lock; /*!< NOR locking object                           */

        __IO HAL_NOR_StateTypeDef
            State; /*!< NOR device access state                      */

        uint32_t
            CommandSet; /*!< NOR algorithm command set and control        */

#if (USE_HAL_NOR_REGISTER_CALLBACKS == 1)
        void (*MspInitCallback)(
            struct __NOR_HandleTypeDef*
                hnor); /*!< NOR Msp Init callback              */
        void (*MspDeInitCallback)(
            struct __NOR_HandleTypeDef*
                hnor); /*!< NOR Msp DeInit callback            */
#endif                 /* USE_HAL_NOR_REGISTER_CALLBACKS */
    } NOR_HandleTypeDef;
  ...
  */
    typedef enum
    {
        ...
        HAL_NOR_MSP_DEINIT_CB_ID =
            0x01U /*!< NOR MspDeInit Callback ID        */
...
#define __HAL_NOR_RESET_HANDLE_STATE(__HANDLE__) \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_NOR_Program(NOR_HandleTypeDef* hnor,
                                      uint32_t* pAddress, uint16_t* pData);
