...
#define SRAMCAN_FLESA              \
    ((uint32_t)(SRAMCAN_FLSSA +    \
                (SRAMCAN_FLS_NBR * \
                 SRAMCAN_FLS_SIZE))) /* Filter List Extended Start
                                                                                            Address                  */
...
HAL_StatusTypeDef HAL_FDCAN_Init(FDCAN_HandleTypeDef* hfdcan)
{
    ...
    if (hfdcan->State == HAL_FDCAN_STATE_RESET)
    {
        ...
        hfdcan->RxFifo0Callback =
            HAL_FDCAN_RxFifo0Callback; /* RxFifo0Callback     */
        hfdcan->RxFifo1Callback =
            HAL_FDCAN_RxFifo1Callback; /* RxFifo1Callback     */
        ...
        hfdcan->ErrorCallback =
            HAL_FDCAN_ErrorCallback; /* ErrorCallback       */
                                       ...
                                       FDCAN_TxEventFifoTypeDef* pTxEvent)
{
    ...
    if (state == HAL_FDCAN_STATE_BUSY)
    {
        ...
        /* Retrieve DataLength */
        pTxEvent->DataLength =
            ((*TxEventAddress & FDCAN_ELEMENT_MASK_DLC) >> 16U);
