  ...
  */
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
    {
        ...
        void (*BCDCallback)(
            struct __PCD_HandleTypeDef* hpcd,
            PCD_BCD_MsgTypeDef
                msg); /*!< USB OTG PCD BCD callback                */
        void (*LPMCallback)(
            struct __PCD_HandleTypeDef* hpcd,
            PCD_LPM_MsgTypeDef
                msg); /*!< USB OTG PCD LPM callback                */
...
#define __HAL_USB_WAKEUP_EXTI_DISABLE_IT() EXTI->IMR2 &= ~(USB_WAKEUP_EXTI_LINE)
  ...
  */
    ...
    typedef void (*pPCD_DataOutStageCallbackTypeDef)(
        ...
        uint8_t
            epnum); /*!< pointer to USB OTG PCD Data OUT Stage callback     */
    typedef void (*pPCD_DataInStageCallbackTypeDef)(
        PCD_HandleTypeDef* hpcd,
        uint8_t
            epnum); /*!< pointer to USB OTG PCD Data IN Stage callback      */
  ...
  */
    ...
    HAL_StatusTypeDef HAL_PCD_EP_ClrStall(PCD_HandleTypeDef* hpcd,
                                          uint8_t ep_addr);
    HAL_StatusTypeDef HAL_PCD_EP_Flush(PCD_HandleTypeDef const* hpcd,
                                       uint8_t ep_addr);
