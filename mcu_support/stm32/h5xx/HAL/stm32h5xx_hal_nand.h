...
#include "stm32h5xx_ll_fmc.h"
  ...
  */
    typedef enum
    {
        ...
        HAL_NAND_STATE_BUSY =
            0x02U, /*!< NAND internal process is ongoing     */
        HAL_NAND_STATE_ERROR =
            0x03U /*!< NAND error state                     */
  ...
  */
    ...
    {
        uint32_t
            PageSize; /*!< NAND memory page (without spare area) size measured in bytes
                                              for 8 bits addressing or words for 16 bits addressing             */

        uint32_t
            SpareAreaSize; /*!< NAND memory spare area size measured in bytes
                                              for 8 bits addressing or words for 16 bits addressing             */
        ...
        uint32_t
            BlockNbr; /*!< NAND memory number of total blocks                               */

        uint32_t
            PlaneNbr; /*!< NAND memory number of planes                                     */
...
/**
  ...
  */
...
#endif /* USE_HAL_NAND_REGISTER_CALLBACKS  */
    {
        ...
        HAL_LockTypeDef
            Lock; /*!< NAND locking object                                   */

        __IO HAL_NAND_StateTypeDef
            State; /*!< NAND device access state                              */
  ...
  */
    typedef enum
    {
        HAL_NAND_MSP_INIT_CB_ID =
            0x00U, /*!< NAND MspInit Callback ID          */
        HAL_NAND_MSP_DEINIT_CB_ID =
            0x01U,                /*!< NAND MspDeInit Callback ID        */
...
#define __HAL_NAND_RESET_HANDLE_STATE(__HANDLE__) \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_NAND_Init(
        NAND_HandleTypeDef* hnand, FMC_NAND_PCC_TimingTypeDef* ComSpace_Timing,
