...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            PacketErrorCheckMode; /*!< Specifies if Packet Error Check mode is selected.
                                        This parameter can be a value of @ref SMBUS_packet_error_check_mode */

        uint32_t
            PeripheralMode; /*!< Specifies which mode of Periphal is selected.
  ...
  */
    typedef enum
    {
        ...
        HAL_SMBUS_ERROR_CB_ID =
            0x05U, /*!< SMBUS Error callback ID                         */

        HAL_SMBUS_MSPINIT_CB_ID =
            0x06U, /*!< SMBUS Msp Init callback ID                      */
        HAL_SMBUS_MSPDEINIT_CB_ID =
            0x07U /*!< SMBUS Msp DeInit callback ID                    */
