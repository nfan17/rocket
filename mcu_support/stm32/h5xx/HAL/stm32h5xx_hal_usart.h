...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct __USART_HandleTypeDef
    {
        ...
        uint32_t
            SlaveMode; /*!< Enable/Disable USART SPI Slave Mode. This parameter can be a value
                                                              of @ref USARTEx_Slave_Mode */

        uint32_t
            FifoMode; /*!< Specifies if the FIFO mode will be used. This parameter can be a value
  ...
  */
    typedef enum
    {
        ...
        HAL_USART_MSPINIT_CB_ID =
            0x09U, /*!< USART MspInit callback ID                 */
        HAL_USART_MSPDEINIT_CB_ID =
            0x0AU /*!< USART MspDeInit callback ID               */
...
#define __HAL_USART_GET_IT(__HANDLE__, __INTERRUPT__)                       \
    ((((__HANDLE__)->Instance->ISR &                                        \
       (0x01U << (((__INTERRUPT__) & USART_ISR_MASK) >> USART_ISR_POS))) != \
      0U)                                                                   \
         ? SET                                                              \
         : RESET)
...
/* Callbacks Register/UnRegister functions  ***********************************/
  ...
  */
    ...
    HAL_USART_StateTypeDef HAL_USART_GetState(
        const USART_HandleTypeDef* husart);
