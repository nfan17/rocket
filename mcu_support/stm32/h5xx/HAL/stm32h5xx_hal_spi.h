...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            NSSPolarity; /*!< Specifies which level of SS input/output external signal
        ...
        uint32_t
            TxCRCInitializationPattern; /*!< Specifies the transmitter CRC initialization Pattern used for
                                                     the CRC calculation. This parameter can be a value of
                                                     @ref SPI_CRC_Calculation_Initialization_Pattern */

        uint32_t
            RxCRCInitializationPattern; /*!< Specifies the receiver CRC initialization Pattern used for
                                                     the CRC calculation. This parameter can be a value of
                                                     @ref SPI_CRC_Calculation_Initialization_Pattern */

        uint32_t
            MasterSSIdleness; /*!< Specifies an extra delay, expressed in number of SPI clock cycle
        ...
        uint32_t
            MasterInterDataIdleness; /*!< Specifies minimum time delay (expressed in SPI clock cycles periods)
                                                     inserted between two consecutive data frames in master mode.
                                                     This parameter can be a value of
                                                     @ref SPI_Master_InterData_Idleness */

        uint32_t
            MasterReceiverAutoSusp; /*!< Control continuous SPI transfer in master receiver mode
        ...
        uint32_t
            MasterKeepIOState; /*!< Control of Alternate function GPIOs state
        ...
        uint32_t
            ReadyMasterManagement; /*!< Specifies if RDY Signal is managed internally or not.
                                                     This parameter can be a value of @ref SPI_RDY_Master_Management */

        uint32_t
            ReadyPolarity; /*!< Specifies which level of RDY Signal input (present on RDY pin)
  ...
  */
    ...
    {
        HAL_SPI_STATE_RESET =
            0x00UL, /*!< Peripheral not Initialized                         */
        HAL_SPI_STATE_READY =
            0x01UL, /*!< Peripheral Initialized and ready for use           */
        HAL_SPI_STATE_BUSY =
            0x02UL, /*!< an internal process is ongoing                     */
        HAL_SPI_STATE_BUSY_TX =
            0x03UL, /*!< Data Transmission process is ongoing               */
        HAL_SPI_STATE_BUSY_RX =
            0x04UL, /*!< Data Reception process is ongoing                  */
        HAL_SPI_STATE_BUSY_TX_RX =
            0x05UL, /*!< Data Transmission and Reception process is ongoing */
        HAL_SPI_STATE_ERROR =
            0x06UL, /*!< SPI error state                                    */
        HAL_SPI_STATE_ABORT =
            0x07UL /*!< SPI abort is ongoing                               */
  ...
  */
    typedef struct __SPI_HandleTypeDef
    {
        ...
        DMA_HandleTypeDef*
            hdmatx; /*!< SPI Tx DMA Handle parameters             */

        DMA_HandleTypeDef*
            hdmarx; /*!< SPI Rx DMA Handle parameters             */
        ...
        void (*ErrorCallback)(
            struct __SPI_HandleTypeDef*
                hspi); /*!< SPI Error callback                 */
        void (*AbortCpltCallback)(
            struct __SPI_HandleTypeDef*
                hspi); /*!< SPI Abort callback                 */
        void (*SuspendCallback)(
            struct __SPI_HandleTypeDef*
                hspi); /*!< SPI Suspend callback               */
        void (*MspInitCallback)(
            struct __SPI_HandleTypeDef*
                hspi); /*!< SPI Msp Init callback              */
        void (*MspDeInitCallback)(
            struct __SPI_HandleTypeDef*
                hspi); /*!< SPI Msp DeInit callback            */
  ...
  */
    typedef enum
    {
        HAL_SPI_TX_COMPLETE_CB_ID =
            0x00UL, /*!< SPI Tx Completed callback ID         */
        HAL_SPI_RX_COMPLETE_CB_ID =
            0x01UL, /*!< SPI Rx Completed callback ID         */
        HAL_SPI_TX_RX_COMPLETE_CB_ID =
            0x02UL, /*!< SPI TxRx Completed callback ID       */
        ...
        HAL_SPI_ERROR_CB_ID =
            0x06UL, /*!< SPI Error callback ID                */
        HAL_SPI_ABORT_CB_ID =
            0x07UL, /*!< SPI Abort callback ID                */
        HAL_SPI_SUSPEND_CB_ID =
            0x08UL, /*!< SPI Suspend callback ID              */
        HAL_SPI_MSPINIT_CB_ID =
            0x09UL, /*!< SPI Msp Init callback ID             */
        HAL_SPI_MSPDEINIT_CB_ID =
            0x0AUL /*!< SPI Msp DeInit callback ID           */
