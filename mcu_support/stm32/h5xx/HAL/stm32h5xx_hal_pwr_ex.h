...
#include "stm32h5xx_hal_def.h"
  ...
  */
    ...
    {
        uint32_t
            AVDLevel; /*!< AVDLevel: Specifies the AVD detection level. This
  ...
  */
    ...
    {
        uint32_t
            WakeUpPin; /*!< WakeUpPin: Specifies the Wake-Up pin to be enabled.
                                        This parameter can be a value of @ref
                                        PWREx_WakeUp_Pins
                        */

        uint32_t
            PinPolarity; /*!< PinPolarity: Specifies the Wake-Up pin polarity.
                                          This parameter can be a value of @ref
                                          PWREx_PIN_Polarity
                        */
...
#define PWR_RAM2_MEMORY_BLOCK \
    PWR_PMCR_SRAM2SO /*!< RAM2 48k byte shut-off control in Stop mode          */
