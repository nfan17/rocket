...
#include "stm32h5xx_hal_def.h"
  ...
  */
    ...
    typedef struct
    {
        ...
        uint32_t*
            pInitVect; /*!< The initialization vector used also as initialization
                                         counter in CTR mode */
        ...
        uint32_t
            DataWidthUnit; /*!< Payload Data Width Unit, this parameter can be value of @ref CRYP_Data_Width_Unit */
        uint32_t
            HeaderWidthUnit; /*!< Header Width Unit, this parameter can be value of @ref CRYP_Header_Width_Unit */
        uint32_t
            KeyIVConfigSkip; /*!< CRYP peripheral Key and IV configuration skip, to config Key and Initialization
                                            Vector only once and to skip configuration for consecutive processings.
                                            This parameter can be a value of @ref CRYP_Configuration_Skip */
        uint32_t
            KeyMode; /*!< Key mode selection, this parameter can be value of @ref CRYP_Key_Mode */
        uint32_t
            KeySelect; /*!< Only for SAES : Key selection, this parameter can be value of @ref CRYP_Key_Select */
        uint32_t
            KeyProtection; /*!< Only for SAES : Key protection, this parameter can be value of @ref CRYP_Key_Protection */
  ...
  */
    ...
    typedef struct
    {
        ...
        uint32_t
            KeySize; /*!< This parameter can be a value of @ref CRYP_Key_Size */
        uint32_t* pKey; /*!< The key used for encryption/decryption */
        uint32_t*
            pInitVect; /*!< The initialization vector, counter with CBC and CTR Algorithm */
        uint32_t
            Algorithm; /*!< This parameter can be a value of @ref CRYP_Algorithm_Mode */
        uint32_t
            DataWidthUnit; /*!< This parameter can be value of @ref CRYP_Data_Width_Unit */
        uint32_t
            KeyIVConfigSkip; /*!< This parameter can be a value of @ref CRYP_Configuration_Skip */
        uint32_t
            KeyMode; /*!< This parameter can be value of @ref CRYP_Key_Mode */
        uint32_t Phase; /*!< CRYP peripheral phase */
        uint32_t
            KeyIVConfig;   /*!< CRYP peripheral Key and IV configuration flag */
  ...
  */
    typedef enum
    {
        ...
        HAL_CRYP_SUSPEND =
            0x01U /*!< CRYP processing suspension requested     */
    } HAL_SuspendTypeDef;
#endif /* USE_HAL_CRYP_SUSPEND_RESUME */
...
/**
  ...
  */
...
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
    {
        ...
        uint32_t
            KeyIVConfig; /*!< CRYP peripheral Key and IV configuration flag, used when
                                                           configuration can be skipped */

        uint32_t
            SizesSum; /*!< Sum of successive payloads lengths (in bytes), stored
        ...
        CRYP_ConfigTypeDef
            Init_saved; /*!< copy of CRYP required parameters when processing is suspended */

        uint32_t*
            pCrypInBuffPtr_saved; /*!< copy of CRYP input pointer when processing is suspended */

        uint32_t*
            pCrypOutBuffPtr_saved; /*!< copy of CRYP output pointer when processing is suspended */

        uint32_t
            CrypInCount_saved; /*!< copy of CRYP input data counter when processing is suspended */

        uint32_t
            CrypOutCount_saved; /*!< copy of CRYP output data counter when processing is suspended */

        uint32_t
            Phase_saved; /*!< copy of CRYP authentication phase when processing is suspended */

        __IO HAL_CRYP_STATETypeDef
            State_saved; /*!< copy of CRYP peripheral state when processing is suspended */
        ...
        uint32_t
            CR_saved; /*!< copy of CRYP control register  when processing is suspended*/
        ...
        uint16_t
            CrypHeaderCount_saved; /*!< copy of CRYP header data counter when processing is suspended */

        uint32_t
            SizesSum_saved; /*!< copy of SizesSum when processing is suspended */
  ...
  */
    typedef enum
    {
        HAL_CRYP_MSPINIT_CB_ID =
            0x00U, /*!< CRYP MspInit callback ID                        */
        HAL_CRYP_MSPDEINIT_CB_ID =
            0x01U, /*!< CRYP MspDeInit callback ID                      */
...
#define CRYP_KEYSEL_HW \
    AES_CR_KEYSEL_0 /*!< Only for SAES, Hardware key : derived hardware unique key (DHUK 256-bit) */
...
#define CRYP_KEYPROT_ENABLE \
    AES_CR_KEYPROT /*!< Only for SAES, Key protection between 2 applications with different security contexts */
#define CRYP_KEYPROT_DISABLE \
    0x00000000U /*!< Only for SAES, Key not protected between 2 applications with different security contexts */
    /**
  * @}
  */
...
#include "stm32h5xx_hal_cryp_ex.h"
  ...
  */
    ...
    HAL_StatusTypeDef HAL_CRYP_Encrypt(CRYP_HandleTypeDef* hcryp,
                                       ...
                                       uint32_t* pOutput, uint32_t Timeout);
...
#define IS_CRYP_INIT(CONFIG)                                               \
    (((CONFIG) == CRYP_KEYIVCONFIG_ALWAYS) ||                              \
     ((CONFIG) == CRYP_KEYNOCONFIG) || ((CONFIG) == CRYP_IVCONFIG_ONCE) || \
