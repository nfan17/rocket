...
#define ADC_JSQR_FIELDS                                                  \
    ((ADC_JSQR_JL | ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN | ADC_JSQR_JSQ1 | \
      ...
      ADC_JSQR_JSQ4)) /*!< ADC_JSQR fields of parameters that can
            ...
            if ((hadc->DMA_Handle->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
            {
                    ...
                    (hadc->DMA_Handle->LinkedListQueue->Head != NULL))
                {
                    ...
                    if (HAL_DMAEx_List_GetNodeConfig(
                            &node_conf,
                            hadc->DMA_Handle->LinkedListQueue->Head) != HAL_OK)
                    {
                        return HAL_ERROR;
                    }
    ...
    ADC_HandleTypeDef* hadc, const ADC_InjectionConfTypeDef* pConfigInjected)
{
    ...
    assert_param(
        IS_FUNCTIONAL_STATE(pConfigInjected->InjectedOffsetSaturation));
        ...
        (tmp_adc_is_conversion_on_going_injected == 0UL))
    {
        ...
        else
        {
            ...
            LL_ADC_SetChannelSamplingTime(
                hadc->Instance, pConfigInjected->InjectedChannel,
