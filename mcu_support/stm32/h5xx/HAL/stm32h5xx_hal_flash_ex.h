...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            USERType; /*!< Select the User Option Byte(s) to be configured (used for OPTIONBYTE_USER).
        ...
        uint32_t
            USERConfig2; /*!< Value of the User Option Byte (used for OPTIONBYTE_USER).
        ...
        uint32_t
            Banks; /*!< Select banks for WRP , HDP and secure area configuration.
        ...
        uint32_t
            BootConfig; /*!< Specifies if the Boot Address to be configured: secure or non-secure.
        ...
        uint32_t
            BootLock; /*!< Configuration of the boot lock (used for OPTIONBYTE_BOOT_LOCK).
        ...
        uint32_t
            HDPEndSector; /*!< End sector of HDP area (used for OPTIONBYTE_HDP).
                                This parameter must be a value between 0 and (max number of sectors in the bank - 1) */
        ...
        uint32_t
            WMSecStartSector; /*!< Start sector of secure area (used for OPTIONBYTE_WMSEC).
                                  This parameter must be a value between 0 and (max number of sectors in the bank - 1)*/
        uint32_t
            WMSecEndSector; /*!< End sector of secure area (used for OPTIONBYTE_WMSEC).
                                  This parameter must be a value between 0 and (max number of sectors in the bank - 1)*/
  ...
  */
    ...
    {
        uint32_t
            Bank; /*!< Selection of the associated bank of Block-based Area.
                                                             This parameter must be a value of @ref FLASH_Banks */
        ...
        uint32_t BBAttributes_array
            [FLASH_BLOCKBASED_NB_REG]; /*!< Each bit specifies the block-based attribute configuration
                                                             of a sector:
...
#if defined(FLASH_SR_OBKERR)
#define FLASH_TYPEERASE_OBK_ALT     \
    (FLASH_OBKCFGR_ALT_SECT_ERASE | \
     FLASH_NON_SECURE_MASK) /*!< Flash OBK erase
                                                                                                  activation */
#endif                      /* FLASH_SR_OBKERR */
#endif                      /* __ARM_FEATURE_CMSE */
/**
...
#define OB_USER_ALL                                                          \
    (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | \
     ...
     OB_USER_SRAM2_ECC | OB_USER_TZEN)
#else
#define OB_USER_ALL                                                          \
    (OB_USER_BOR_LEV | OB_USER_BORH_EN | OB_USER_IWDG_SW | OB_USER_WWDG_SW | \
     OB_USER_NRST_STOP | OB_USER_NRST_STDBY | OB_USER_IO_VDD_HSLV |          \
...
#define OB_BOR_LEVEL_3       \
    (FLASH_OPTSR_BOR_LEV_1 | \
     FLASH_OPTSR_BOR_LEV_0) /*!< Reset level 3 threshold */
/**
  * @}
  */
...
#define FLASH_PROGRAMMING_DELAY_1 \
    FLASH_ACR_WRHIGHFREQ_0 /*!< programming delay set for Flash running between 70 MHz
                                                                and 185 MHz */
#define FLASH_PROGRAMMING_DELAY_2 \
    FLASH_ACR_WRHIGHFREQ_1 /*!< programming delay set for Flash running between 185 MHz
                                                                and 225 MHz */
