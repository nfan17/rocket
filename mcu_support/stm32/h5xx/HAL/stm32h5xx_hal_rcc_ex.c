    ...
    const RCC_PeriphCLKInitTypeDef* pPeriphClkInit)
{
        ...
        RCC_PERIPHCLK_USART1)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_USART1CLKSOURCE(pPeriphClkInit->Usart1ClockSelection));
        ...
        RCC_PERIPHCLK_USART2)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_USART2CLKSOURCE(pPeriphClkInit->Usart2ClockSelection));
        ...
        RCC_PERIPHCLK_USART3)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_USART3CLKSOURCE(pPeriphClkInit->Usart3ClockSelection));
        ...
        RCC_PERIPHCLK_UART4)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART4CLKSOURCE(pPeriphClkInit->Uart4ClockSelection));
        ...
        RCC_PERIPHCLK_UART5)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART5CLKSOURCE(pPeriphClkInit->Uart5ClockSelection));
        ...
        RCC_PERIPHCLK_USART6)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_USART6CLKSOURCE(pPeriphClkInit->Usart6ClockSelection));
        ...
        RCC_PERIPHCLK_UART7)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART7CLKSOURCE(pPeriphClkInit->Uart7ClockSelection));
        ...
        RCC_PERIPHCLK_UART8)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART8CLKSOURCE(pPeriphClkInit->Uart8ClockSelection));
        ...
        RCC_PERIPHCLK_UART9)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART9CLKSOURCE(pPeriphClkInit->Uart9ClockSelection));
        ...
        RCC_PERIPHCLK_UART12)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_UART12CLKSOURCE(pPeriphClkInit->Uart12ClockSelection));
        ...
        RCC_PERIPHCLK_ADCDAC)
    {
        /* Check the parameters */
        assert_param(
            IS_RCC_ADCDACCLKSOURCE(pPeriphClkInit->AdcDacClockSelection));
        ...
        RCC_PERIPHCLK_SDMMC1)
    {
        ...
        /* Check the parameters */
        assert_param(
            IS_RCC_SDMMC1CLKSOURCE(pPeriphClkInit->Sdmmc1ClockSelection));
        ...
        RCC_PERIPHCLK_SDMMC2)
    {
        ...
        /* Check the parameters */
        assert_param(
            IS_RCC_SDMMC2CLKSOURCE(pPeriphClkInit->Sdmmc2ClockSelection));
    ...
    else
    {
        ...
        switch (PeriphClk)
        {
            ...
            case RCC_PERIPHCLK_USART1:
                ...
                {
                    frequency = (HSI_VALUE >> (__HAL_RCC_GET_HSI_DIVIDER() >>
                                               RCC_CR_HSIDIV_Pos));
                }
                else if ((HAL_IS_BIT_SET(RCC->CR, RCC_CR_CSIRDY)) &&
...
static HAL_StatusTypeDef RCCEx_PLL2_Config(const RCC_PLL2InitTypeDef* pll2)
{
    ...
    __HAL_RCC_PLL2_CONFIG(pll2->PLL2Source, pll2->PLL2M, pll2->PLL2N,
                          pll2->PLL2P, pll2->PLL2Q, pll2->PLL2R);
...
static HAL_StatusTypeDef RCCEx_PLL3_Config(const RCC_PLL3InitTypeDef* pll3)
{
    ...
    __HAL_RCC_PLL3_CONFIG(pll3->PLL3Source, pll3->PLL3M, pll3->PLL3N,
                          pll3->PLL3P, pll3->PLL3Q, pll3->PLL3R);
