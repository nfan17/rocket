...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            LimitAddress; /*!< Specifies the limit address of the region to protect.                */
        ...
        uint8_t
            AccessPermission; /*!< Specifies the region access permission type. This parameter
  ...
  */
    ...
    {
        uint8_t
            Number; /*!< Specifies the number of the memory attributes to configure.
                                                 This parameter can be a value of @ref CORTEX_MPU_Attributes_Number   */

        uint8_t
            Attributes; /*!< Specifies the memory attributes value. Attributes This parameter
...
#define MPU_HFNMI_PRIVDEF_NONE \
    0U /*!< MPU is disabled during HardFault and NMI handlers,
                                                 privileged software access to the default memory map is disabled */
#define MPU_HARDFAULT_NMI \
    2U /*!< MPU is enabled during HardFault and NMI handlers,
                                                 privileged software access to the default memory map is disabled */
#define MPU_PRIVILEGED_DEFAULT \
    4U /*!< MPU is disabled during HardFault and NMI handlers,
                                                 privileged software access to the default memory map is enabled  */
#define MPU_HFNMI_PRIVDEF \
    6U /*!< MPU is enabled during HardFault and NMI handlers,
                                                 privileged software access to the default memory map is enabled  */
/**
  * @}
  */
...
#define MPU_INSTRUCTION_ACCESS_ENABLE \
    0U /*!< MPU region execution permitted (if read permitted) */
#define MPU_INSTRUCTION_ACCESS_DISABLE \
    1U /*!< MPU region execution not permitted                 */
/**
  * @}
  */
...
#define MPU_REGION_PRIV_RW \
    0U /*!< MPU region Read/write by privileged code only */
#define MPU_REGION_ALL_RW \
    1U /*!< MPU region Read/write by any privilege level  */
#define MPU_REGION_PRIV_RO \
    2U /*!< MPU region Read-only by privileged code only  */
#define MPU_REGION_ALL_RO \
    3U /*!< MPU region Read-only by any privilege level   */
/**
  * @}
  */
...
#define MPU_DEVICE_nGnRnE \
    0x0U /*!< Device, noGather, noReorder, noEarly acknowledge. */
#define MPU_DEVICE_nGnRE \
    0x4U /*!< Device, noGather, noReorder, Early acknowledge.   */
#define MPU_DEVICE_nGRE \
    0x8U /*!< Device, noGather, Reorder, Early acknowledge.     */
#define MPU_DEVICE_GRE \
    0xCU /*!< Device, Gather, Reorder, Early acknowledge.       */
