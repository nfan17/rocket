...
#include "stm32h5xx_ll_adc.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            RightBitShift; /*!< Configures the division coefficient for the Oversampler.
  ...
  */
    ...
    {
        uint32_t
            ContextQueue; /*!< Injected channel configuration context: build-up over each
...
typedef struct
#endif /* USE_HAL_ADC_REGISTER_CALLBACKS */
    {
        ...
        void (*ConvHalfCpltCallback)(
            struct __ADC_HandleTypeDef*
                hadc); /*!< ADC conversion DMA half-transfer
                                                                                 callback */
        ...
        void (*InjectedConvCpltCallback)(
            struct __ADC_HandleTypeDef*
                hadc); /*!< ADC group injected conversion complete
                                                                                 callback */
        void (*InjectedQueueOverflowCallback)(
            struct __ADC_HandleTypeDef*
                hadc); /*!< ADC group injected context queue
                                                                                 overflow callback */
  ...
  */
    typedef enum
    {
        ...
        HAL_ADC_MSPDEINIT_CB_ID =
            0x0AU /*!< ADC Msp DeInit callback ID        */
