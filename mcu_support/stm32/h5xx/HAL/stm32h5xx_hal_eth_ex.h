...
#include "stm32h5xx_hal_def.h"
  ...
  */
    ...
    {
        FunctionalState
            InnerVLANTagInStatus; /*!< Enables or disables Inner VLAN Tag in Rx Status  */

        uint32_t
            StripInnerVLANTag; /*!< Sets the Inner VLAN Tag Stripping on Receive
  ...
  */
    ...
    {
        FunctionalState
            SourceTxDesc; /*!< Enable or Disable VLAN tag source from DMA tx descriptors */
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            SrcAddrFilterMatch; /*!< Sets the L3 filter source address match
                                         This parameter can be a value of @ref ETHEx_L3_Source_Match */

        uint32_t
            DestAddrFilterMatch; /*!< Sets the L3 filter destination address match
                                         This parameter can be a value of @ref ETHEx_L3_Destination_Match */

        uint32_t
            SrcAddrHigherBitsMatch; /*!< Sets the L3 filter source address higher bits match
                                         This parameter can be a value from 0 to 31 */

        uint32_t
            DestAddrHigherBitsMatch; /*!< Sets the L3 filter destination address higher bits match
                                         This parameter can be a value from 0 to 31 */

        uint32_t
            Ip4SrcAddr; /*!< Sets the L3 filter IPv4 source address if IPv4 protocol is used
                                         This parameter can be a value from 0x0 to 0xFFFFFFFF */

        uint32_t
            Ip4DestAddr; /*!< Sets the L3 filter IPv4 destination  address if IPv4 protocol is used
                                         This parameter can be a value from 0 to 0xFFFFFFFF  */

        uint32_t Ip6Addr
            [4]; /*!< Sets the L3 filter IPv6 address if IPv6 protocol is used
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            DestPortFilterMatch; /*!< Sets the L4 filter destination port match
...
#define ETH_OUTER_TX_VLANTAG 0x00000000U
  ...
  */
    ...
    HAL_StatusTypeDef HAL_ETHEx_GetL3FilterConfig(
        ETH_HandleTypeDef* heth, uint32_t Filter,
    ...
    HAL_StatusTypeDef HAL_ETHEx_GetRxVLANConfig(
        ETH_HandleTypeDef* heth, ETH_RxVLANConfigTypeDef* pVlanConfig);
