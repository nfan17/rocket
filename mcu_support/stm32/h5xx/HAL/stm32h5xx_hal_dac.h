...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef enum
    {
        ...
        HAL_DAC_STATE_READY =
            0x01U,                  /*!< DAC initialized and ready for use    */
        HAL_DAC_STATE_BUSY = 0x02U, /*!< DAC internal processing is ongoing   */
        HAL_DAC_STATE_TIMEOUT =
            0x03U,                  /*!< DAC timeout state                    */
...
/**
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            DAC_HoldTime; /*!< Specifies the hold time for the selected channel
                                          This parameter applies when DAC_SampleAndHold is DAC_SAMPLEANDHOLD_ENABLE.
                                          This parameter must be a number between Min_Data = 0 and Max_Data = 1023 */
  ...
  */
    typedef enum
    {
        ...
        HAL_DAC_MSPDEINIT_CB_ID =
            0x09U,                /*!< DAC MspDeInit Callback ID         */
...
#define DAC_TRIGGER_NONE \
    0x00000000UL /*!< conversion is automatic once the DAC_DHRxxxx register has been loaded, and not by external trigger */
...
#define DAC_TRIGGER_LPTIM2_CH1         \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | \
     DAC_CR_TEN1) /*!< LPTIM2 CH1 selected as external conversion trigger for DAC channel */
...
#include "stm32h5xx_hal_dac_ex.h"
  ...
  */
    ...
    HAL_StatusTypeDef HAL_DAC_ConfigChannel(
        DAC_HandleTypeDef* hdac, const DAC_ChannelConfTypeDef* sConfig,
        uint32_t Channel);
    /**
  * @}
  */
