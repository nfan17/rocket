  ...
  */
    typedef enum
    {
        ...
        HAL_MMC_STATE_TIMEOUT = ((
            uint32_t)0x00000002U), /*!< MMC Timeout state                    */
        HAL_MMC_STATE_BUSY = ((
            uint32_t)0x00000003U), /*!< MMC process ongoing                  */
        ...
        HAL_MMC_STATE_TRANSFER = ((
            uint32_t)0x00000006U), /*!< MMC Transfer State                   */
        HAL_MMC_STATE_ERROR =
            ((uint32_t)0x0000000FU) /*!< MMC is in error state                */
...
/**
  ...
  */
...
#endif /* USE_HAL_MMC_REGISTER_CALLBACKS */
    {
        ...
        __IO HAL_MMC_StateTypeDef
            State; /*!< MMC card State                       */

        __IO uint32_t ErrorCode; /*!< MMC Card Error codes                 */

        HAL_MMC_CardInfoTypeDef
            MmcCard; /*!< MMC Card information                 */
    ...
    (USE_HAL_MMC_REGISTER_CALLBACKS == 1U)
        ...
        void (*Write_DMALnkLstBufCpltCallback)(
  ...
  */
    typedef enum
    {
        HAL_MMC_TX_CPLT_CB_ID =
            0x00U, /*!< MMC Tx Complete Callback ID                     */
        HAL_MMC_RX_CPLT_CB_ID =
            0x01U, /*!< MMC Rx Complete Callback ID                     */
        HAL_MMC_ERROR_CB_ID =
            0x02U, /*!< MMC Error Callback ID                           */
        HAL_MMC_ABORT_CB_ID =
            0x03U, /*!< MMC Abort Callback ID                           */
        ...
        HAL_MMC_MSP_INIT_CB_ID =
            0x10U, /*!< MMC MspInit Callback ID                         */
        HAL_MMC_MSP_DEINIT_CB_ID =
            0x11U /*!< MMC MspDeInit Callback ID                       */
...
#include "stm32h5xx_hal_mmc_ex.h"
  ...
  */
    ...
    HAL_StatusTypeDef HAL_MMC_RegisterCallback(
        MMC_HandleTypeDef* hmmc, HAL_MMC_CallbackIDTypeDef CallbackId,
  ...
  */
    ...
    HAL_StatusTypeDef HAL_MMC_GetSupportedSecRemovalType(
        MMC_HandleTypeDef* hmmc, uint32_t* SupportedSRT);
    /**
  * @}
  */
