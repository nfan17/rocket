...
static HAL_StatusTypeDef I3C_Ctrl_IsDevice_Ready(
    I3C_HandleTypeDef* hi3c, const I3C_DeviceTypeDef* pDevice, uint32_t trials,
    uint32_t timeout);
...
HAL_StatusTypeDef HAL_I3C_Init(I3C_HandleTypeDef* hi3c)
{
    ...
    else
    {
        ...
        if (hi3c->Mode == HAL_I3C_MODE_CONTROLLER)
        {
            ...
            assert_param(IS_I3C_WAITTIME_VALUE(
                hi3c->Init.CtrlBusCharacteristic.WaitTime));
...
HAL_StatusTypeDef HAL_I3C_RegisterTgtHotJoinCallback(
    I3C_HandleTypeDef* hi3c, pI3C_TgtHotJoinCallbackTypeDef pTgtHotJoinCallback)
{
    HAL_StatusTypeDef status = HAL_OK;
        ...
        if (HAL_I3C_STATE_READY == hi3c->State)
        {
            switch (callbackID)
            {
                ...
                case HAL_I3C_TGT_REQ_DYNAMIC_ADDR_CB_ID:
                    /*Legacy weak TgtReqDynamicAddrCallback          */
                    hi3c->TgtReqDynamicAddrCallback =
                                     ...
                                     const I3C_TgtConfTypeDef* pConfig)
{
    ...
    else
    {
        ...
        {
            /* Check configuration parameters values */
            assert_param(IS_I3C_HANDOFFACTIVITYSTATE_VALUE(
                pConfig->HandOffActivityState));
            assert_param(
    ...
    else
    {
        ...
        else
        {
            ...
            for (uint32_t index = 0U; index < nbDevice; index++)
            {
                ...
                assert_param(IS_I3C_DYNAMICADDRESS_VALUE(
                    pDesc[index].TargetDynamicAddr));
                assert_param(IS_I3C_FUNCTIONALSTATE_VALUE(pDesc[index].IBIAck));
                assert_param(
                    IS_I3C_FUNCTIONALSTATE_VALUE(pDesc[index].CtrlRoleReqAck));
                assert_param(IS_I3C_FUNCTIONALSTATE_VALUE(
                    pDesc[index].CtrlStopTransfer));
                assert_param(
                                         ...
                                         uint8_t nbFrame, uint32_t option)
{
    ...
    else
    {
        ...
        if (((option & I3C_OPERATION_TYPE_MASK) ==
...
HAL_StatusTypeDef HAL_I3C_ClearConfigFifo(I3C_HandleTypeDef* hi3c)
{
    ...
    else
    {
        ...
        else
        {
            ...
            cfgr_value =
                (LL_I3C_TXFIFO_THRESHOLD_1_4 | LL_I3C_RXFIFO_THRESHOLD_1_4);
            cfgr_mask = (I3C_CFGR_TXTHRES | I3C_CFGR_RXTHRES);
                                        ...
                                        I3C_FifoConfTypeDef* pConfig)
{
    ...
    else
    {
        ...
        else
        {
            ...
            pConfig->TxFifoThreshold =
                LL_I3C_GetTxFIFOThreshold(hi3c->Instance);

            /* Get Rx Fifo threshold */
            pConfig->RxFifoThreshold =
                LL_I3C_GetRxFIFOThreshold(hi3c->Instance);
    ...
    else
    {
        ...
        else
        {
            ...
            assert_param(IS_I3C_DMADESTINATIONWORD_VALUE(
                hi3c->hdmacr->Init.DestDataWidth));
            ...
            if (hi3c->RxXferCount != 0U)
            {
                    ...
                    LL_I3C_RXFIFO_THRESHOLD_1_4)
                {
                    ...
                    rx_dma_status = HAL_DMA_Start_IT(
                        hi3c->hdmarx, (uint32_t)&hi3c->Instance->RDR,
                    ...
                    (handle_state == HAL_I3C_STATE_BUSY_DAA))
                {
                    ...
                    if (__HAL_I3C_GET_FLAG(hi3c, HAL_I3C_FLAG_TXFNFF) == SET)
                    {
                        ...
                        else
                        {
                            ...
                            *target_payload =
                                (uint64_t)LL_I3C_ReceiveData32(hi3c->Instance);
        ...
        if (status == HAL_OK)
        {
                ...
                LL_I3C_IBI_ADDITIONAL_DATA)
            {
                ...
                else
                {
                    ...
                    {
                        payload_value |=
                            ((uint32_t)pPayload[index] << (index * 8U));
                    }
                                     ...
                                     I3C_CCCInfoTypeDef* pCCCInfo)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                pCCCInfo->MaxReadLength =
                    LL_I3C_GetMaxReadLength(hi3c->Instance);
            }
            ...
            {
                pCCCInfo->ActivityState =
                    LL_I3C_GetActivityState(hi3c->Instance);
            }
            ...
            {
                pCCCInfo->IBICRTgtAddr =
                    LL_I3C_GetIBITargetAddr(hi3c->Instance);
