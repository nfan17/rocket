...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            Bank; /*!< Internal variable to save current bank selected during erase in
                                                  IT context */
        ...
        uint32_t
            NbSectorsToErase; /*!< Internal variable to save the remaining sectors to erase in
                                                  IT context  */
...
#define FLASH_FLAG_ALL_ERRORS \
    (FLASH_FLAG_SR_ERRORS |   \
     FLASH_FLAG_ECCR_ERRORS) /*!< All FLASH error flags */
/**
  * @}
  */
...
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                      \
    ...
    {                                                                         \
        ...
        if (((__FLAG__) &                                                     \
             ~(FLASH_FLAG_ECCR_ERRORS | FLASH_FLAG_OPTCHANGEERR)) != 0U)      \
        {                                                                     \
            WRITE_REG(FLASH->SECCCR,                                          \
                      ((__FLAG__) &                                           \
