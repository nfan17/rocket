    ...
    if (IS_I2S_MASTER(hi2s->Init.Mode))
    {
        ...
        if (hi2s->Init.AudioFreq != I2S_AUDIOFREQ_DEFAULT)
        {
            ...
            else
            {
                ...
                tmp = (uint32_t)((((i2sclk / ((32UL >> ispcm) * packetlength)) *
                                   10UL) /
                                  hi2s->Init.AudioFreq) +
                                 5UL);
            }
                                       ...
                                       const uint16_t* pData, uint16_t Size)
{
    ...
    {
        errorcode = HAL_DMA_Start_IT(hi2s->hdmatx, (uint32_t)hi2s->pTxBuffPtr,
                                     (uint32_t)&hi2s->Instance->TXDR,
                                     hi2s->TxXferCount);
    }
                                      ...
                                      uint16_t Size)
{
    ...
    {
        errorcode =
            HAL_DMA_Start_IT(hi2s->hdmarx, (uint32_t)&hi2s->Instance->RXDR,
