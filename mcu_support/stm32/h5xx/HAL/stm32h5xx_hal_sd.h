  ...
  */
    typedef enum
    {
        ...
        HAL_SD_STATE_TIMEOUT =
            ((uint32_t)0x00000002U), /*!< SD Timeout state                    */
        HAL_SD_STATE_BUSY =
            ((uint32_t)0x00000003U), /*!< SD process ongoing                  */
        HAL_SD_STATE_PROGRAMMING =
            ((uint32_t)0x00000004U), /*!< SD Programming State                */
        HAL_SD_STATE_RECEIVING =
            ((uint32_t)0x00000005U), /*!< SD Receiving State                  */
        HAL_SD_STATE_TRANSFER =
            ((uint32_t)0x00000006U), /*!< SD Transfer State                   */
        HAL_SD_STATE_ERROR =
            ((uint32_t)0x0000000FU) /*!< SD is in error state                */
    } HAL_SD_StateTypeDef;
    /**
  * @}
  */
...
#define SD_TypeDef SDMMC_TypeDef
  ...
  */
    ...
    {
        uint32_t
            CardType; /*!< Specifies the card Type                         */
        ...
        uint32_t
            RelCardAdd; /*!< Specifies the Relative Card Address             */

        uint32_t
            BlockNbr; /*!< Specifies the Card Capacity in blocks           */

        uint32_t
            BlockSize; /*!< Specifies one block size in bytes               */
        ...
        uint32_t
            CardSpeed; /*!< Specifies the card Speed                        */
...
/**
  ...
  */
    typedef struct
    {
        ...
        __IO uint8_t
            FileFormatGroup;   /*!< File format group                     */
  ...
  */
    ...
    {
        __IO uint8_t
            DataBusWidth; /*!< Shows the currently defined data bus width                 */
        __IO uint8_t
            SecuredMode; /*!< Card is in secured mode of operation                       */
        __IO uint16_t
            CardType; /*!< Carries information about card type                        */
        __IO uint32_t
        ...
        __IO uint16_t
            EraseSize; /*!< Determines the number of AUs to be erased in one operation */
        __IO uint8_t
            EraseTimeout; /*!< Determines the timeout for any number of AU erase          */
        __IO uint8_t
            EraseOffset; /*!< Carries information about the erase offset                 */
        __IO uint8_t
            UhsSpeedGrade; /*!< Carries information about the speed grade of UHS card      */
        __IO uint8_t
  ...
  */
    typedef enum
    {
        HAL_SD_TX_CPLT_CB_ID =
            0x00U, /*!< SD Tx Complete Callback ID                     */
        HAL_SD_RX_CPLT_CB_ID =
            0x01U, /*!< SD Rx Complete Callback ID                     */
        HAL_SD_ERROR_CB_ID =
            0x02U, /*!< SD Error Callback ID                           */
        HAL_SD_ABORT_CB_ID =
            0x03U, /*!< SD Abort Callback ID                           */
        ...
        HAL_SD_MSP_INIT_CB_ID =
            0x10U, /*!< SD MspInit Callback ID                         */
        HAL_SD_MSP_DEINIT_CB_ID =
            0x11U /*!< SD MspDeInit Callback ID                       */
...
#include "stm32h5xx_hal_sd_ex.h"
  ...
  */
    ...
    HAL_StatusTypeDef HAL_SD_RegisterTransceiverCallback(
        SD_HandleTypeDef* hsd, pSD_TransceiverCallbackTypeDef pCallback);
    HAL_StatusTypeDef HAL_SD_UnRegisterTransceiverCallback(
