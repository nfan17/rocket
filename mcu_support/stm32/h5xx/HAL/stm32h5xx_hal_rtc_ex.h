...
#define RTC_ATAMP_SEED_NB_UINT32 4U
  ...
  */
    ...
    typedef struct
    {
        ...
        uint32_t
            ActiveAsyncPrescaler; /*!< Specifies the Active Tamper asynchronous Prescaler clock.
                                             This parameter can be a value of
                                             @ref RTCEx_ActiveTamper_Async_prescaler */

        uint32_t
            TimeStampOnTamperDetection; /*!< Specifies the timeStamp on tamper detection.
                                             This parameter can be a value of
                                             @ref RTCEx_Tamper_TimeStampOnTamperDetection */

        uint32_t
            ActiveOutputChangePeriod; /*!< Specifies the Active Tamper output change period.
  ...
  */
    ...
    {
        uint32_t
            rtcSecureFull; /*!< Specifies If the RTC is fully secure or not.
        ...
        uint32_t
            tampSecureFull; /*!< Specifies If the TAMP is fully secure or not execpt monotonic counters
        ...
        uint32_t
            MonotonicCounterSecure; /*!< Specifies If the monotonic counter is secure or not.
                                             This parameter can be a value of
  ...
  */
    ...
    {
        uint32_t
            rtcPrivilegeFull; /*!< Specifies If the RTC is fully privileged or not.
        ...
        uint32_t
            tampPrivilegeFull; /*!< Specifies If the TAMP is fully privileged or not execpt monotonic
                                             counters and BackUp registers.
                                             This parameter can be a value of @ref RTCEx_TAMP_Privilege_Full */

        uint32_t
            backupRegisterPrivZone; /*!< Specifies backup register zone to be privileged.
                                             This parameter can be a combination of
        ...
        uint32_t
            MonotonicCounterPrivilege; /*!< Specifies If the monotonic counter is privileged or not.
                                             This parameter can be a value of
...
#define RTC_LPCAL_SET \
    RTC_CALR_LPCAL /*!< Calibration window is 2exp20 ck_apre, which is the required configuration for ultra-low consumption mode. */
...
#define RTC_INT_TAMPER_ALL                                       \
    (RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 |    \
     ...
     RTC_INT_TAMPER_7 | RTC_INT_TAMPER_8 | RTC_INT_TAMPER_9 |    \
     RTC_INT_TAMPER_11 | RTC_INT_TAMPER_12 | RTC_INT_TAMPER_13 | \
     RTC_INT_TAMPER_15)
/**
  * @}
  */
...
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK \
    (TAMP_FLTCR_TAMPPRCH_0 |                \
     TAMP_FLTCR_TAMPPRCH_1) /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK cycles */
/**
  * @}
  */
...
#define RTC_BINARY_MIX_BCDU_1 \
    (0x1UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[8:0] = 0  */
#define RTC_BINARY_MIX_BCDU_2 \
    (0x2UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[9:0] = 0  */
#define RTC_BINARY_MIX_BCDU_3 \
    (0x3UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[10:0] = 0 */
#define RTC_BINARY_MIX_BCDU_4 \
    (0x4UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[11:0] = 0 */
#define RTC_BINARY_MIX_BCDU_5 \
    (0x5UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[12:0] = 0 */
#define RTC_BINARY_MIX_BCDU_6 \
    (0x6UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[13:0] = 0 */
#define RTC_BINARY_MIX_BCDU_7 \
    (0x7UL                    \
     << RTC_ICSR_BCDU_Pos) /*!<  The 1s BCD calendar increment is generated each time SS[14:0] = 0 */
/**
  * @}
  */
...
#define RTC_ALARMSUBSECONDBINMASK_SS31_1 \
    (1UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:1] are don't care in Alarm comparison. Only SS[0] is compared            */
#define RTC_ALARMSUBSECONDBINMASK_SS31_2 \
    (2UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:2] are don't care in Alarm comparison. Only SS[1:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_3 \
    (3UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:3] are don't care in Alarm comparison. Only SS[2:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_4 \
    (4UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:4] are don't care in Alarm comparison. Only SS[3:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_5 \
    (5UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:5] are don't care in Alarm comparison. Only SS[4:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_6 \
    (6UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:6] are don't care in Alarm comparison. Only SS[5:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_7 \
    (7UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:7] are don't care in Alarm comparison. Only SS[6:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_8 \
    (8UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:8] are don't care in Alarm comparison. Only SS[7:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_9 \
    (9UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:9] are don't care in Alarm comparison. Only SS[8:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_10 \
    (10UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:10] are don't care in Alarm comparison. Only SS[9:0] are compared        */
#define RTC_ALARMSUBSECONDBINMASK_SS31_11 \
    (11UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:11] are don't care in Alarm comparison. Only SS[10:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_12 \
    (12UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:12] are don't care in Alarm comparison.Only SS[11:0] are compared        */
#define RTC_ALARMSUBSECONDBINMASK_SS31_13 \
    (13UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:13] are don't care in Alarm comparison. Only SS[12:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_14 \
    (14UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:14] are don't care in Alarm comparison. Only SS[13:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_15 \
    (15UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:15] are don't care in Alarm comparison. Only SS[14:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_16 \
    (16UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:16] are don't care in Alarm comparison. Only SS[15:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_17 \
    (17UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:17] are don't care in Alarm comparison. Only SS[16:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_18 \
    (18UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:18] are don't care in Alarm comparison. Only SS[17:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_19 \
    (19UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:19] are don't care in Alarm comparison. Only SS[18:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_20 \
    (20UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:20] are don't care in Alarm comparison. Only SS[19:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_21 \
    (21UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:21] are don't care in Alarm comparison. Only SS[20:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_22 \
    (22UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:22] are don't care in Alarm comparison. Only SS[21:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_23 \
    (23UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:23] are don't care in Alarm comparison. Only SS[22:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_24 \
    (24UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:24] are don't care in Alarm comparison. Only SS[23:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_25 \
    (25UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:25] are don't care in Alarm comparison. Only SS[24:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_26 \
    (26UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:26] are don't care in Alarm comparison. Only SS[25:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_27 \
    (27UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:27] are don't care in Alarm comparison. Only SS[26:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_28 \
    (28UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:28] are don't care in Alarm comparison. Only SS[27:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_29 \
    (29UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:29] are don't care in Alarm comparison. Only SS[28:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_30 \
    (30UL                                 \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:30] are don't care in Alarm comparison. Only SS[29:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31 \
    (31UL                              \
     << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31] is don't care in Alarm comparison. Only SS[30:0] are compared           */
...
#define __HAL_RTC_SSRU_CLEAR_FLAG(__HANDLE__, __FLAG__) \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_RTCEx_PollForTimeStampEvent(
        const RTC_HandleTypeDef* hrtc, uint32_t Timeout);
  ...
  */
    ...
    HAL_StatusTypeDef HAL_RTCEx_MonotonicCounterIncrement(
        const RTC_HandleTypeDef* hrtc, uint32_t Instance);
    HAL_StatusTypeDef HAL_RTCEx_MonotonicCounterGet(
        const RTC_HandleTypeDef* hrtc, uint32_t Instance, uint32_t* pValue);
  ...
  */
    ...
    HAL_StatusTypeDef HAL_RTCEx_SetActiveTampers(
        RTC_HandleTypeDef* hrtc, const RTC_ActiveTampersTypeDef* sAllTamper);
    ...
    HAL_StatusTypeDef HAL_RTCEx_DeactivateTamper(const RTC_HandleTypeDef* hrtc,
                                                 uint32_t Tamper);
    HAL_StatusTypeDef HAL_RTCEx_DeactivateActiveTampers(
        const RTC_HandleTypeDef* hrtc);
    HAL_StatusTypeDef HAL_RTCEx_PollForTamperEvent(
        const RTC_HandleTypeDef* hrtc, uint32_t Tamper, uint32_t Timeout);
    ...
    HAL_StatusTypeDef HAL_RTCEx_DeactivateInternalTamper(
        const RTC_HandleTypeDef* hrtc, uint32_t IntTamper);
    HAL_StatusTypeDef HAL_RTCEx_PollForInternalTamperEvent(
        const RTC_HandleTypeDef* hrtc, uint32_t IntTamper, uint32_t Timeout);
#if defined(TAMP_SECCFGR_BHKLOCK)
    HAL_StatusTypeDef HAL_RTCEx_LockBootHardwareKey(
        const RTC_HandleTypeDef* hrtc);
  ...
  * @{
  */
    void HAL_RTCEx_BKUPWrite(const RTC_HandleTypeDef* hrtc,
  ...
  * @{
  */
    HAL_StatusTypeDef HAL_RTCEx_SecureModeGet(
        const RTC_HandleTypeDef* hrtc, RTC_SecureStateTypeDef* secureState);
