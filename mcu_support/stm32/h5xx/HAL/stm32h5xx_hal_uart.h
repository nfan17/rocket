...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            OverSampling; /*!< Specifies whether the Over sampling 8 is enabled or disabled,
  ...
  */
    ...
    {
        uint32_t
            AdvFeatureInit; /*!< Specifies which advanced UART features is initialized. Several
  ...
  */
    typedef struct __UART_HandleTypeDef
    {
        ...
        __IO HAL_UART_RxEventTypeTypeDef
            RxEventType; /*!< Type of Rx Event                   */
  ...
  */
    typedef enum
    {
        ...
        HAL_UART_MSPINIT_CB_ID =
            0x0BU, /*!< UART MspInit callback ID                 */
        HAL_UART_MSPDEINIT_CB_ID =
            0x0CU /*!< UART MspDeInit callback ID               */
...
/* Callbacks Register/UnRegister functions  ***********************************/
  ...
  */
    ...
    HAL_StatusTypeDef HAL_UART_DisableReceiverTimeout(
        UART_HandleTypeDef* huart);
