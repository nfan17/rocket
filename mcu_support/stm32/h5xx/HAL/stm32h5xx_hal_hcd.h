...
/** @defgroup HCD_Exported_Types_Group2 HCD Handle Structure definition
  ...
  */
...
#endif /* USE_HAL_HCD_REGISTER_CALLBACKS */
    {
        ...
        uint32_t
            ep0_PmaAllocState; /*!< EP0 PMA allocation State (allocated, virtual Ch, EP0 direction) */
        uint16_t
            phy_chin_state[8]; /*!< Physical Channel in State (Used/Free) */
        uint16_t
            phy_chout_state[8]; /*!< Physical Channel out State (Used/Free)*/
        ...
        void (*SOFCallback)(
            struct __HCD_HandleTypeDef*
                hhcd); /*!< USB OTG HCD SOF callback                */
        void (*ConnectCallback)(
            struct __HCD_HandleTypeDef*
                hhcd); /*!< USB OTG HCD Connect callback            */
        ...
        void (*MspInitCallback)(
            struct __HCD_HandleTypeDef*
                hhcd); /*!< USB OTG HCD Msp Init callback           */
...
#define __HAL_HCD_GET_CHDIR(__HANDLE__) \
  ...
  */
    typedef enum
    {
        ...
        HAL_HCD_DISCONNECT_CB_ID =
            0x03, /*!< USB HCD Disconnect callback ID    */
        HAL_HCD_PORT_ENABLED_CB_ID =
            0x04, /*!< USB HCD Port Enable callback ID   */
  ...
  */
    ...
    HAL_StatusTypeDef HAL_HCD_PMADeAlloc(HCD_HandleTypeDef* hhcd,
                                         uint8_t ch_num);
