...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            OutPutPolarity; /*!< Specifies the polarity of the output signal.
        ...
        uint32_t
            BinMixBcdU; /*!< Specifies the BCD calendar update if and only if BinMode = RTC_BINARY_MIX.
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            FlagAutoClr; /*!< Specifies the alarm trigger generation. This feature is meaningful
...
typedef struct
    ...
    {
        RTC_TypeDef*
            Instance; /*!< Legacy register base address. Not used anymore, the driver directly uses cmsis base address */
        ...
        void (*Tamper4EventCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Tamper 4 Event callback           */
        void (*Tamper5EventCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Tamper 5 Event callback           */
        void (*Tamper6EventCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Tamper 6 Event callback           */
        void (*Tamper7EventCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Tamper 7 Event callback           */
        void (*Tamper8EventCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Tamper 8 Event callback           */
        ...
        void (*MspInitCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Msp Init callback                 */
        void (*MspDeInitCallback)(
            struct __RTC_HandleTypeDef*
                hrtc); /*!< RTC Msp DeInit callback               */
  ...
  */
    typedef enum
    {
        ...
        HAL_RTC_SSRU_EVENT_CB_ID =
            4U, /*!< RTC SSRU Event Callback ID         */
        HAL_RTC_TAMPER1_EVENT_CB_ID =
            5U, /*!< RTC Tamper 1 Callback ID           */
        HAL_RTC_TAMPER2_EVENT_CB_ID =
            6U, /*!< RTC Tamper 2 Callback ID           */
        HAL_RTC_TAMPER3_EVENT_CB_ID =
            7U, /*!< RTC Tamper 3 Callback ID           */
        HAL_RTC_TAMPER4_EVENT_CB_ID =
            8U, /*!< RTC Tamper 4 Callback ID           */
        HAL_RTC_TAMPER5_EVENT_CB_ID =
            9U, /*!< RTC Tamper 5 Callback ID           */
        HAL_RTC_TAMPER6_EVENT_CB_ID =
            10U, /*!< RTC Tamper 6 Callback ID           */
        HAL_RTC_TAMPER7_EVENT_CB_ID =
            11U, /*!< RTC Tamper 7 Callback ID           */
        HAL_RTC_TAMPER8_EVENT_CB_ID =
            12U, /*!< RTC Tamper 8 Callback ID           */
...
#define RTC_ALARMSUBSECONDMASK_SS14_2 \
    RTC_ALRMASSR_MASKSS_1 /*!< SS[14:2] not used in Alarm comparison. Only SS[1:0] are compared                */
...
#define RTC_ALARMSUBSECONDMASK_SS14_4 \
    RTC_ALRMASSR_MASKSS_2 /*!< SS[14:4] not used in Alarm comparison. Only SS[3:0] are compared                */
...
#define RTC_ALARMSUBSECONDMASK_SS14_8 \
    RTC_ALRMASSR_MASKSS_3 /*!< SS[14:8] not used in Alarm comparison. Only SS[7:0] are compared                */
...
#define RTC_FLAG_SSRUF \
    (0x00000200U | RTC_SR_SSRUF_Pos) /*!< Clear SSR underflow flag       */
#define RTC_FLAG_ITSF \
    (0x00000200U | RTC_SR_ITSF_Pos) /*!< Clear Internal Time-stamp flag */
#define RTC_FLAG_TSOVF \
    (0x00000200U | RTC_SR_TSOVF_Pos) /*!< Clear Time-stamp overflow flag */
#define RTC_FLAG_TSF \
    (0x00000200U | RTC_SR_TSF_Pos) /*!< Clear Time-stamp flag          */
#define RTC_FLAG_WUTF \
    (0x00000200U | RTC_SR_WUTF_Pos) /*!< Clear Wakeup timer flag        */
#define RTC_FLAG_ALRBF \
    (0x00000200U | RTC_SR_ALRBF_Pos) /*!< Clear Alarm B flag             */
#define RTC_FLAG_ALRAF \
    (0x00000200U | RTC_SR_ALRAF_Pos) /*!< Clear Alarm A flag             */
/**
  * @}
  */
