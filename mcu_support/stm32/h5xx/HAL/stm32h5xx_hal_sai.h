...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            MckOutput; /*!< Specifies whether master clock output will be generated or not.
        ...
        uint32_t
            MonoStereoMode; /*!< Specifies if the mono or stereo mode is selected.
  ...
  */
    typedef enum
    {
        ...
        HAL_SAI_STATE_READY =
            0x01U,                  /*!< SAI initialized and ready for use    */
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            FSDefinition; /*!< Specifies the Frame synchronization definition.
  ...
  */
    ...
    {
        uint32_t
            FirstBitOffset; /*!< Specifies the position of first data transfer bit in the slot.
        ...
        uint32_t
            SlotActive; /*!< Specifies the slots in audio frame that will be activated.
