...
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_BuildNode(
    MMC_DMALinkNodeTypeDef* pNode, MMC_DMALinkNodeConfTypeDef* pNodeConf)
{
...
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_InsertNode(
    MMC_DMALinkedListTypeDef* pLinkedList, MMC_DMALinkNodeTypeDef* pPrevNode,
...
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_RemoveNode(
    MMC_DMALinkedListTypeDef* pLinkedList, MMC_DMALinkNodeTypeDef* pNode)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_LockNode(
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_UnlockNode(
    MMC_DMALinkNodeTypeDef* pNode)
{
...
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_ReadBlocks(
    MMC_HandleTypeDef* hmmc, MMC_DMALinkedListTypeDef* pLinkedList,
    uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
    ...
    if (hmmc->State == HAL_MMC_STATE_READY)
    {
        ...
        hmmc->Instance->IDMALAR =
            (uint32_t)SDMMC_IDMALAR_ABR | SDMMC_IDMALAR_ULS |
            SDMMC_IDMALAR_ULA |
