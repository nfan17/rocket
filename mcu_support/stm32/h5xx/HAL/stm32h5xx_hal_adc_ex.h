...
#include "stm32h5xx_hal_def.h"
  ...
  */
    ...
    {
        uint32_t
            InjectedChannel; /*!< Specifies the channel to configure into ADC group injected.
        ...
        uint32_t
            InjectedOffset; /*!< Defines the offset to be applied on the raw converted data.
...
#define ADC_OFFSET_NONE \
    (ADC_OFFSET_4 +     \
     1U) /*!< ADC offset disabled: no offset correction for the selected
                                     ADC channel */
#define ADC_OFFSET_1 \
