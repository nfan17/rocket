...
#include "stm32h5xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint8_t
            Prescaler; /*!< Specifies the Prescaler value for dividing the UART/USART source clock
        ...
        uint32_t
            ClockPrescaler; /*!< Specifies the prescaler value used to divide the IRDA clock source.
  ...
  */
    typedef enum
    {
        ...
        HAL_IRDA_MSPINIT_CB_ID =
            0x08U, /*!< IRDA MspInit callback ID                 */
        HAL_IRDA_MSPDEINIT_CB_ID =
            0x09U /*!< IRDA MspDeInit callback ID               */
