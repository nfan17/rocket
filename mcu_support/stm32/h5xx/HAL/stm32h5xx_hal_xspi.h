...
#define HAL_XSPI_DLYB_CfgTypeDef LL_DLYB_CfgTypeDef
  ...
  */
    ...
    {
        uint32_t
            FifoThresholdByte; /*!< This is the threshold used by the Peripheral to generate the interrupt
        ...
        uint32_t
            MemoryType; /*!< It indicates the external device type connected to the XSPI.
                                           This parameter can be a value of @ref XSPI_MemoryType */
        uint32_t
            MemorySize; /*!< It defines the size of the external device connected to the XSPI,
                                           it corresponds to the number of address bits required to access
                                           the external device.
                                           This parameter can be a value of @ref XSPI_MemorySize*/
        uint32_t
            ChipSelectHighTimeCycle; /*!< It defines the minimum number of clocks which the chip select
                                           must remain high between commands.
                                           This parameter can be a value between 1 and 64U */
        uint32_t
            FreeRunningClock; /*!< It enables or not the free running clock.
                                           This parameter can be a value of @ref XSPI_FreeRunningClock */
        uint32_t
            ClockMode; /*!< It indicates the level of clock when the chip select is released.
                                           This parameter can be a value of @ref XSPI_ClockMode */
        uint32_t
            WrapSize; /*!< It indicates the wrap-size corresponding the external device configuration.
        ...
        uint32_t
            SampleShifting; /*!< It allows to delay to 1/2 cycle the data sampling in order
                                           to take in account external signal delays.
                                           This parameter can be a value of @ref XSPI_SampleShifting */
        uint32_t
            DelayHoldQuarterCycle; /*!< It allows to hold to 1/4 cycle the data.
                                           This parameter can be a value of @ref XSPI_DelayHoldQuarterCycle */
        uint32_t
            ChipSelectBoundary; /*!< It enables the transaction boundary feature and
                                           defines the boundary of bytes to release the chip select.
                                           This parameter can be a value of @ref XSPI_ChipSelectBoundary  */
        uint32_t
            DelayBlockBypass; /*!< It enables the delay block bypass, so the sampling is not affected
                                           by the delay block.
                                           This parameter can be a value of @ref XSPI_DelayBlockBypass */
        uint32_t
            Refresh; /*!< It enables the refresh rate feature. The chip select is released every
...
/**
  ...
  */
    ...
    {
        XSPI_TypeDef*
            Instance; /*!< XSPI registers base address                           */
        XSPI_InitTypeDef
            Init; /*!< XSPI initialization parameters                        */
        uint8_t*
            pBuffPtr; /*!< Address of the XSPI buffer for transfer               */
        __IO uint32_t
            XferSize; /*!< Number of data to transfer                            */
        __IO uint32_t
            XferCount; /*!< Counter of data transferred                           */
        DMA_HandleTypeDef*
            hdmatx; /*!< Handle of the DMA channel used for transmit           */
        DMA_HandleTypeDef*
            hdmarx; /*!< Handle of the DMA channel used for receive            */
        __IO uint32_t
            State; /*!< Internal state of the XSPI HAL driver                 */
        __IO uint32_t
            ErrorCode; /*!< Error code in case of HAL driver internal error       */
        uint32_t
            Timeout; /*!< Timeout used for the XSPI external device access      */
#if defined(USE_HAL_XSPI_REGISTER_CALLBACKS) && \
    (USE_HAL_XSPI_REGISTER_CALLBACKS == 1U)
  ...
  */
    ...
    {
        uint32_t
            OperationType; /*!< It indicates if the configuration applies to the common registers or
        ...
        uint32_t
            IOSelect; /*!< It indicates the IOs used to exchange data with external memory.
                                           This parameter can be a value of @ref XSPI_IOSelect */
        uint32_t
            Instruction; /*!< It contains the instruction to be sent to the device.
        ...
        uint32_t
            InstructionWidth; /*!< It indicates the width of the instruction.
                                           This parameter can be a value of @ref XSPI_InstructionWidth */
        uint32_t
            InstructionDTRMode; /*!< It enables or not the DTR mode for the instruction phase.
        ...
        uint32_t Address; /*!< It contains the address to be sent to the device.
                                           This parameter can be a value between 0 and 0xFFFFFFFF */
        uint32_t
            AddressMode; /*!< It indicates the address mode. Address mode precises number of lines
        ...
        uint32_t
            AddressDTRMode; /*!< It enables or not the DTR mode for the address phase.
                                           This parameter can be a value of @ref XSPI_AddressDTRMode */
        uint32_t
            AlternateBytes; /*!< It contains the alternate bytes to be sent to the device.
                                           This parameter can be a value between 0 and 0xFFFFFFFF */
        uint32_t
            AlternateBytesMode; /*!< It indicates the mode of the alternate bytes.
                                           This parameter can be a value of @ref XSPI_AlternateBytesMode */
        uint32_t
            AlternateBytesWidth; /*!< It indicates the width of the alternate bytes.
                                           This parameter can be a value of @ref XSPI_AlternateBytesWidth */
        uint32_t
            AlternateBytesDTRMode; /*!< It enables or not the DTR mode for the alternate bytes phase.
                                           This parameter can be a value of @ref XSPI_AlternateBytesDTRMode */
        uint32_t
            DataMode; /*!< It indicates the data mode. Data mode precises number of lines
                                           for data exchange (except no data).
                                           This parameter can be a value of @ref XSPI_DataMode */
        uint32_t
            DataLength; /*!< It indicates the number of data transferred with this command.
                                           This field is only used for indirect mode.
                                           This parameter can be a value between 1 and 0xFFFFFFFFU */
        uint32_t
            DataDTRMode; /*!< It enables or not the DTR mode for the data phase.
                                           This parameter can be a value of @ref XSPI_DataDTRMode */
        uint32_t
            DummyCycles; /*!< It indicates the number of dummy cycles inserted before data phase.
  ...
  */
    ...
    {
        uint32_t
            RWRecoveryTimeCycle; /*!< It indicates the number of cycles for the device read write recovery time.
                                           This parameter can be a value between 0 and 255U */
        uint32_t
            AccessTimeCycle; /*!< It indicates the number of cycles for the device access time.
                                           This parameter can be a value between 0 and 255U */
        uint32_t
            WriteZeroLatency; /*!< It enables or not the latency for the write access.
  ...
  */
    ...
    {
        uint32_t
            AddressSpace; /*!< It indicates the address space accessed by the command.
  ...
  */
    ...
    {
        uint32_t
            MatchValue; /*!< Specifies the value to be compared with the masked status register to get
                                           a match.
                                           This parameter can be any value between 0 and 0xFFFFFFFFU */
        uint32_t
            MatchMask; /*!< Specifies the mask to be applied to the status bytes received.
                                           This parameter can be any value between 0 and 0xFFFFFFFFU */
        uint32_t
            MatchMode; /*!< Specifies the method used for determining a match.
                                           This parameter can be a value of @ref XSPI_MatchMode */
        uint32_t
            AutomaticStop; /*!< Specifies if automatic polling is stopped after a match.
                                           This parameter can be a value of @ref XSPI_AutomaticStop */
        uint32_t
            IntervalTime; /*!< Specifies the number of clock cycles between two read during automatic
                                           polling phases.
  ...
  */
    ...
    {
        uint32_t
            TimeOutActivation; /*!< Specifies if the timeout counter is enabled to release the chip select.
                                           This parameter can be a value of @ref XSPI_TimeOutActivation */
        uint32_t
            TimeoutPeriodClock; /*!< Specifies the number of clock to wait when the FIFO is full before to
  ...
  */
    typedef enum
    {
        ...
        HAL_XSPI_FIFO_THRESHOLD_CB_ID =
            0x02U, /*!< XSPI FIFO Threshold Callback ID   */
        HAL_XSPI_CMD_CPLT_CB_ID =
            0x03U, /*!< XSPI Command Complete Callback ID */
        HAL_XSPI_RX_CPLT_CB_ID =
            0x04U, /*!< XSPI Rx Complete Callback ID      */
        HAL_XSPI_TX_CPLT_CB_ID =
            0x05U, /*!< XSPI Tx Complete Callback ID      */
        HAL_XSPI_RX_HALF_CPLT_CB_ID =
            0x06U, /*!< XSPI Rx Half Complete Callback ID */
        HAL_XSPI_TX_HALF_CPLT_CB_ID =
            0x07U, /*!< XSPI Tx Half Complete Callback ID */
        HAL_XSPI_STATUS_MATCH_CB_ID =
            0x08U, /*!< XSPI Status Match Callback ID     */
        HAL_XSPI_TIMEOUT_CB_ID =
            0x09U, /*!< XSPI Timeout Callback ID          */
        HAL_XSPI_MSP_INIT_CB_ID =
            0x0AU, /*!< XSPI MspInit Callback ID          */
        HAL_XSPI_MSP_DEINIT_CB_ID =
            0x0BU /*!< XSPI MspDeInit Callback ID        */
...
#define HAL_XSPI_STATE_HYPERBUS_INIT \
    (0x00000001U) /*!< Initialization done in hyperbus mode but timing configuration not done */
...
#define HAL_XSPI_SIZE_128B \
    (0x00000003U) /*!< 128 bits  ( 16  Byte = 2^( 3+1)) */
#define HAL_XSPI_SIZE_256B \
    (0x00000004U) /*!< 256 bits  ( 32  Byte = 2^( 4+1)) */
#define HAL_XSPI_SIZE_512B \
    (0x00000005U)                       /*!< 512 bits  ( 64  Byte = 2^( 5+1)) */
...
#define HAL_XSPI_SIZE_16KB \
    (0x0000000AU) /*!<  16 Kbits (  2 KByte = 2^(10+1)) */
#define HAL_XSPI_SIZE_32KB \
    (0x0000000BU) /*!<  32 Kbits (  4 KByte = 2^(11+1)) */
#define HAL_XSPI_SIZE_64KB \
    (0x0000000CU) /*!<  64 Kbits (  8 KByte = 2^(12+1)) */
#define HAL_XSPI_SIZE_128KB \
    (0x0000000DU) /*!< 128 Kbits ( 16 KByte = 2^(13+1)) */
#define HAL_XSPI_SIZE_256KB \
    (0x0000000EU) /*!< 256 Kbits ( 32 KByte = 2^(14+1)) */
#define HAL_XSPI_SIZE_512KB \
    (0x0000000FU)                       /*!< 512 Kbits ( 64 KByte = 2^(15+1)) */
...
#define HAL_XSPI_SIZE_16MB \
    (0x00000014U) /*!<  16 Mbits (  2 MByte = 2^(20+1)) */
#define HAL_XSPI_SIZE_32MB \
    (0x00000015U) /*!<  32 Mbits (  4 MByte = 2^(21+1)) */
#define HAL_XSPI_SIZE_64MB \
    (0x00000016U) /*!<  64 Mbits (  8 MByte = 2^(22+1)) */
#define HAL_XSPI_SIZE_128MB \
    (0x00000017U) /*!< 128 Mbits ( 16 MByte = 2^(23+1)) */
#define HAL_XSPI_SIZE_256MB \
    (0x00000018U) /*!< 256 Mbits ( 32 MByte = 2^(24+1)) */
#define HAL_XSPI_SIZE_512MB \
    (0x00000019U)                       /*!< 512 Mbits ( 64 MByte = 2^(25+1)) */
...
#define HAL_XSPI_SIZE_16GB \
    (0x0000001EU) /*!<  16 Gbits (256 MByte = 2^(30+1)) */
#define HAL_XSPI_SIZE_32GB \
    (0x0000001FU) /*!<  32 Gbits (256 MByte = 2^(31+1)) */
/**
  * @}
  */
...
#define HAL_XSPI_WRAP_16_BYTES \
    ((uint32_t)                \
         XSPI_DCR2_WRAPSIZE_1) /*!< external memory supports wrap size of 16 bytes  */
#define HAL_XSPI_WRAP_32_BYTES         \
    ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | \
                XSPI_DCR2_WRAPSIZE_1)) /*!< external memory supports wrap size of 32 bytes  */
#define HAL_XSPI_WRAP_64_BYTES \
    ((uint32_t)                \
         XSPI_DCR2_WRAPSIZE_2) /*!< external memory supports wrap size of 64 bytes  */
#define HAL_XSPI_WRAP_128_BYTES        \
    ((uint32_t)(XSPI_DCR2_WRAPSIZE_0 | \
                XSPI_DCR2_WRAPSIZE_2)) /*!< external memory supports wrap size of 128 bytes */
/**
  * @}
  */
...
#define HAL_XSPI_BONDARYOF_16B \
    (0x00000001U) /*!<  16 bits  (  2  Byte = 2^(1))  */
#define HAL_XSPI_BONDARYOF_32B \
    (0x00000002U) /*!<  32 bits  (  4  Byte = 2^(2))  */
#define HAL_XSPI_BONDARYOF_64B \
    (0x00000003U) /*!<  64 bits  (  8  Byte = 2^(3))  */
#define HAL_XSPI_BONDARYOF_128B \
    (0x00000004U) /*!< 128 bits  ( 16  Byte = 2^(4))  */
#define HAL_XSPI_BONDARYOF_256B \
    (0x00000005U) /*!< 256 bits  ( 32  Byte = 2^(5))  */
#define HAL_XSPI_BONDARYOF_512B \
    (0x00000006U) /*!< 512 bits  ( 64  Byte = 2^(6))  */
#define HAL_XSPI_BONDARYOF_1KB \
    (0x00000007U) /*!<   1 Kbits (128  Byte = 2^(7))  */
#define HAL_XSPI_BONDARYOF_2KB \
    (0x00000008U) /*!<   2 Kbits (256  Byte = 2^(8))  */
#define HAL_XSPI_BONDARYOF_4KB \
    (0x00000009U) /*!<   4 Kbits (512  Byte = 2^(9))  */
#define HAL_XSPI_BONDARYOF_8KB \
    (0x0000000AU) /*!<   8 Kbits (  1 KByte = 2^(10)) */
#define HAL_XSPI_BONDARYOF_16KB \
    (0x0000000BU) /*!<  16 Kbits (  2 KByte = 2^(11)) */
#define HAL_XSPI_BONDARYOF_32KB \
    (0x0000000CU) /*!<  32 Kbits (  4 KByte = 2^(12)) */
#define HAL_XSPI_BONDARYOF_64KB \
    (0x0000000DU) /*!< 64 Kbits  (  8 KByte = 2^(13)) */
#define HAL_XSPI_BONDARYOF_128KB \
    (0x0000000EU) /*!< 128 Kbits ( 16 KByte = 2^(14)) */
#define HAL_XSPI_BONDARYOF_256KB \
    (0x0000000FU) /*!< 256 Kbits ( 32 KByte = 2^(15)) */
#define HAL_XSPI_BONDARYOF_512KB \
    (0x00000010U) /*!< 512 Kbits ( 64 KByte = 2^(16)) */
#define HAL_XSPI_BONDARYOF_1MB \
    (0x00000011U) /*!<   1 Mbits (128 KByte = 2^(17)) */
#define HAL_XSPI_BONDARYOF_2MB \
    (0x00000012U) /*!<   2 Mbits (256 KByte = 2^(18)) */
#define HAL_XSPI_BONDARYOF_4MB \
    (0x00000013U) /*!<   4 Mbits (512 KByte = 2^(19)) */
#define HAL_XSPI_BONDARYOF_8MB \
    (0x00000014U) /*!<   8 Mbits (  1 MByte = 2^(20)) */
#define HAL_XSPI_BONDARYOF_16MB \
    (0x00000015U) /*!<  16 Mbits (  2 MByte = 2^(21)) */
#define HAL_XSPI_BONDARYOF_32MB \
    (0x00000016U) /*!<  32 Mbits (  4 MByte = 2^(22)) */
#define HAL_XSPI_BONDARYOF_64MB \
    (0x00000017U) /*!<  64 Mbits (  8 MByte = 2^(23)) */
#define HAL_XSPI_BONDARYOF_128MB \
    (0x00000018U) /*!< 128 Mbits ( 16 MByte = 2^(24)) */
#define HAL_XSPI_BONDARYOF_256MB \
    (0x00000019U) /*!< 256 Mbits ( 32 MByte = 2^(25)) */
#define HAL_XSPI_BONDARYOF_512MB \
    (0x0000001AU) /*!< 512 Mbits ( 64 MByte = 2^(26)) */
#define HAL_XSPI_BONDARYOF_1GB \
    (0x0000001BU) /*!<   1 Gbits (128 MByte = 2^(27)) */
#define HAL_XSPI_BONDARYOF_2GB \
    (0x0000001CU) /*!<   2 Gbits (256 MByte = 2^(28)) */
#define HAL_XSPI_BONDARYOF_4GB \
    (0x0000001DU) /*!<   4 Gbits (512 MByte = 2^(29)) */
#define HAL_XSPI_BONDARYOF_8GB \
    (0x0000001EU) /*!<   8 Gbits (  1 GByte = 2^(30)) */
#define HAL_XSPI_BONDARYOF_16GB \
    (0x0000001FU) /*!<  16 Gbits (  2 GByte = 2^(31)) */
/**
  * @}
  */
...
#define HAL_XSPI_DELAY_BLOCK_BYPASS \
    ((uint32_t)                     \
         OCTOSPI_DCR1_DLYBYP) /*!< Delay block is bypassed                      */
/**
  * @}
  */
...
#define HAL_XSPI_ALT_BYTES_DTR_ENABLE \
    ((uint32_t)                       \
         XSPI_CCR_ABDTR) /*!< DTR mode enabled for alternate bytes phase  */
/**
  * @}
  */
...
#define HAL_XSPI_DATA_1_LINE \
    ((uint32_t)              \
         XSPI_CCR_DMODE_0) /*!< Data on a single line                     */
#define HAL_XSPI_DATA_2_LINES \
    ((uint32_t)               \
         XSPI_CCR_DMODE_1) /*!< Data on two lines                         */
#define HAL_XSPI_DATA_4_LINES      \
    ((uint32_t)(XSPI_CCR_DMODE_0 | \
                XSPI_CCR_DMODE_1)) /*!< Data on four lines                        */
#define HAL_XSPI_DATA_8_LINES \
    ((uint32_t)               \
         XSPI_CCR_DMODE_2) /*!< Data on eight lines                       */
/**
  * @}
  */
...
#define HAL_XSPI_SIOO_INST_ONLY_FIRST_CMD \
    ((uint32_t)                           \
         XSPI_CCR_SIOO) /*!< Send instruction only for the first command */
/**
  * @}
  */
...
#define HAL_XSPI_AUTOMATIC_STOP_ENABLE \
    ((uint32_t)                        \
         XSPI_CR_APMS) /*!< AutoPolling stops as soon as there is a match       */
/**
  * @}
  */
...
#define HAL_XSPI_TIMEOUT_COUNTER_ENABLE \
    ((uint32_t)                         \
         XSPI_CR_TCEN) /*!< Timeout counter enabled, nCS released when timeout expires */
/**
  * @}
  */
...
#define HAL_XSPI_FLAG_FT \
    XSPI_SR_FTF /*!< Fifo threshold flag: Fifo threshold reached or data left after read from memory is complete              */
#define HAL_XSPI_FLAG_TC \
    XSPI_SR_TCF /*!< Transfer complete flag: programmed number of data have been transferred or the transfer has been aborted */
...
#define HAL_XSPI_CLEAR_FLAG(__HANDLE__, __FLAG__) \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_XSPI_AutoPolling(XSPI_HandleTypeDef* hxspi,
                                           ...
                                           uint32_t Timeout);
    HAL_StatusTypeDef HAL_XSPI_AutoPolling_IT(
        XSPI_HandleTypeDef* hxspi, XSPI_AutoPollingTypeDef* const pCfg);

    /* XSPI memory-mapped mode functions */
    HAL_StatusTypeDef HAL_XSPI_MemoryMapped(
        XSPI_HandleTypeDef* hxspi, XSPI_MemoryMappedTypeDef* const pCfg);
    ...
    HAL_StatusTypeDef HAL_XSPI_RegisterCallback(
        XSPI_HandleTypeDef* hxspi, HAL_XSPI_CallbackIDTypeDef CallbackID,
        pXSPI_CallbackTypeDef pCallback);
    HAL_StatusTypeDef HAL_XSPI_UnRegisterCallback(
        XSPI_HandleTypeDef* hxspi, HAL_XSPI_CallbackIDTypeDef CallbackID);
#endif /* (USE_HAL_XSPI_REGISTER_CALLBACKS) && (USE_HAL_XSPI_REGISTER_CALLBACKS == 1U) */
  ...
  */
    ...
    HAL_StatusTypeDef HAL_XSPI_DLYB_SetConfig(
        XSPI_HandleTypeDef* hxspi, HAL_XSPI_DLYB_CfgTypeDef* const pdlyb_cfg);
    HAL_StatusTypeDef HAL_XSPI_DLYB_GetConfig(
        XSPI_HandleTypeDef* hxspi, HAL_XSPI_DLYB_CfgTypeDef* const pdlyb_cfg);
...
#define IS_XSPI_LATENCY_MODE(MODE)            \
    (((MODE) == HAL_XSPI_VARIABLE_LATENCY) || \
