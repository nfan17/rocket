...
/** @addtogroup STM32H5xx_HAL_Driver
  ...
  */
    ...
    typedef struct
    {
        ...
        uint32_t
            InvertingInput; /*!< Specifies the inverting input in Standalone & PGA modes.
        ...
        uint32_t
            NonInvertingInput; /*!< Specifies the non inverting input of the opamp:
        ...
        uint32_t
            TrimmingValueP; /*!< Specifies the offset trimming value (PMOS) in Normal Mode
                                             i.e. when UserTrimming is OPAMP_TRIMMING_USER.
                                             This parameter must be a number between Min_Data = 0 and Max_Data = 31.
                                             16 is typical default value                                              */

        uint32_t
            TrimmingValueN; /*!< Specifies the offset trimming value (NMOS) in Normal Mode
                                             i.e. when UserTrimming is OPAMP_TRIMMING_USER.
                                             This parameter must be a number between Min_Data = 0 and Max_Data = 31.
                                             16 is typical default value                                              */

        uint32_t
            TrimmingValuePHighSpeed; /*!< Specifies the offset trimming value (PMOS) in High Speed Mode
                                             i.e. when UserTrimming is OPAMP_TRIMMING_USER.
                                             This parameter must be a number between Min_Data = 0 and Max_Data = 31.
                                             16 is typical default value                                              */

        uint32_t
            TrimmingValueNHighSpeed; /*!< Specifies the offset trimming value (NMOS) in High Speed Mode
                                             i.e. when UserTrimming is OPAMP_TRIMMING_USER.
                                             This parameter must be a number between Min_Data = 0 and Max_Data = 31.
                                             16 is typical default value                                              */
  ...
  */
    ...
    typedef enum
    {
        HAL_OPAMP_STATE_RESET =
            0x00000000U, /*!< OPAMP is not yet Initialized                                         */
...
/**
  ...
  */
...
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */
    {
        ...
        HAL_StatusTypeDef
            Status;           /*!< OPAMP peripheral status                 */
        HAL_LockTypeDef Lock; /*!< Locking object                          */
        __IO HAL_OPAMP_StateTypeDef
            State; /*!< OPAMP communication state               */
...
#define OPAMP_PGA_GAIN_16_OR_MINUS_15 \
    (OPAMP_CSR_PGGAIN_0 |             \
     OPAMP_CSR_PGGAIN_1) /*!< PGA gain could be 16 or -15 */
...
/* Peripheral Control functions */
    ...
    HAL_OPAMP_TrimmingValueTypeDef HAL_OPAMP_GetTrimOffset(
        const OPAMP_HandleTypeDef* hopamp, uint32_t trimmingoffset);
  ...
  */
    ...
    HAL_OPAMP_StateTypeDef HAL_OPAMP_GetState(
        const OPAMP_HandleTypeDef* hopamp);
