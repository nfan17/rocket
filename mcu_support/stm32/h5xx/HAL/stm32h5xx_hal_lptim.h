...
#include "stm32h5xx_ll_lptim.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            Input1Source; /*!< Specifies source selected for input1 (GPIO or comparator output).
  ...
  */
    typedef enum
    {
        ...
        HAL_LPTIM_STATE_ERROR =
            0x04U /*!< Internal Process is ongoing                 */
  ...
  */
    typedef enum
    {
        ...
        HAL_LPTIM_ACTIVE_CHANNEL_CLEARED =
  ...
  */
    typedef enum
    {
        HAL_LPTIM_CHANNEL_STATE_RESET =
            0x00U, /*!< LPTIM Channel initial state                         */
        HAL_LPTIM_CHANNEL_STATE_READY =
            0x01U, /*!< LPTIM Channel ready for use                         */
...
/**
  ...
  */
...
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
    {
        ...
        DMA_HandleTypeDef* hdma
            [3]; /*!< DMA Handlers array, This array is accessed by a @ref LPTIM_DMA_Handle_index */
        ...
        __IO HAL_LPTIM_ChannelStateTypeDef ChannelState
            [2]; /*!< LPTIM channel operation state                       */
#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1)
  ...
  */
    typedef enum
    {
        ...
        HAL_LPTIM_ERROR_CB_ID =
            0x0CU, /*!< LPTIM Error Callback ID                          */
        HAL_LPTIM_IC_CAPTURE_CB_ID =
            0x0DU, /*!< Input capture Callback ID                        */
        HAL_LPTIM_IC_CAPTURE_HALF_CB_ID =
            0x0EU, /*!< Input capture half complete Callback ID          */
        HAL_LPTIM_OVER_CAPTURE_CB_ID =
            0x0FU, /*!< Over capture Callback ID                         */
...
#define LPTIM_DMA_ID_CC1 \
    ((uint16_t)0x0001) /*!< Index of the DMA handle used for Capture/Update event 1 DMA request */
#define LPTIM_DMA_ID_CC2 \
    ((uint16_t)0x0002) /*!< Index of the DMA handle used for Capture/Update event 2 DMA request */
/**
  * @}
  */
...
#define LPTIM_ICPOLARITY_RISING_FALLING \
    (LPTIM_CCMR1_CC1P_0 |               \
     LPTIM_CCMR1_CC1P_1) /*!< Capture/Compare input rising and falling polarities */
/**
  * @}
  */
...
#define LPTIM_ICFLT_CLOCK_DIV1 \
    0x00000000UL /*!< any external input capture signal level change is considered as a valid transition */
#define LPTIM_ICFLT_CLOCK_DIV2 \
    LPTIM_CCMR1_IC1F_0 /*!< external input capture signal level change must be stable for at least 2 clock periods before it is considered as valid transition */
#define LPTIM_ICFLT_CLOCK_DIV4 \
    LPTIM_CCMR1_IC1F_1 /*!< external input capture signal level change must be stable for at least 4 clock periods before it is considered as valid transition */
#define LPTIM_ICFLT_CLOCK_DIV8 \
    (LPTIM_CCMR1_IC1F_0 |      \
     LPTIM_CCMR1_IC1F_1) /*!< external input capture signal level change must be stable for at least 8 clock periods before it is considered as valid transition */
/**
  * @}
  */
...
#define __HAL_LPTIM_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)               \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_LPTIM_OC_ConfigChannel(
        LPTIM_HandleTypeDef* hlptim, const LPTIM_OC_ConfigTypeDef* sConfig,
        uint32_t Channel);
    ...
    HAL_StatusTypeDef HAL_LPTIM_IC_ConfigChannel(
        LPTIM_HandleTypeDef* hlptim, const LPTIM_IC_ConfigTypeDef* sConfig,
        uint32_t Channel);
