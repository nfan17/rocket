...
#define EXTI_LINE_23 \
    (EXTI_CONFIG |   \
     0x17u) /*!< External interrupt line 23 Connected to the LPTIM Wakeup event */
#if defined(EXTI_IMR_IM24)
#define EXTI_LINE_24 \
    (EXTI_CONFIG |   \
     0x18u) /*!< External interrupt line 24 Connected to the MDIO Slave global Interrupt Wakeup event */
#endif      /* EXTI_IMR_IM24 */
/**
  * @}
  */
