...
#define HAL_FLASH_ERROR_ERS \
    ((uint32_t)0x00000002U) /*!< Programming Sequence error    */
#define HAL_FLASH_ERROR_PGP \
    ((uint32_t)0x00000004U) /*!< Programming Parallelism error */
#define HAL_FLASH_ERROR_PGA \
    ((uint32_t)0x00000008U) /*!< Programming Alignment error   */
#define HAL_FLASH_ERROR_WRP \
    ((uint32_t)0x00000010U) /*!< Write protection error        */
#define HAL_FLASH_ERROR_OPERATION \
    ((uint32_t)0x00000020U) /*!< Operation Error               */
#define HAL_FLASH_ERROR_RD \
    ((uint32_t)0x00000040U) /*!< Read Protection Error         */
/**
  * @}
  */
...
#define FLASH_FLAG_RDERR \
    FLASH_SR_RDERR /*!< FLASH Read protection error flag          */
...
#define FLASH_IT_ERR \
    ((uint32_t)0x02000000U) /*!< Error Interrupt source                  */
/**
  * @}
  */
