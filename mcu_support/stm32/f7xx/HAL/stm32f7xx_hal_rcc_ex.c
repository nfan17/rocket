    ...
    RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    if ((plli2sused == 1) || ((PeriphClkInit->PeriphClockSelection &
                               RCC_PERIPHCLK_PLLI2S) == RCC_PERIPHCLK_PLLI2S))
    {
        /* Disable the PLLI2S */
            ...
            RCC_PERIPHCLK_SPDIFRX)
        {
            ...
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SN,
                                    PeriphClkInit->PLLI2S.PLLI2SP, tmpreg0,
                                    tmpreg1);
        }
            ...
            RCC_PERIPHCLK_PLLI2S)
        {
            ...
            __HAL_RCC_PLLI2S_CONFIG(
                PeriphClkInit->PLLI2S.PLLI2SN, PeriphClkInit->PLLI2S.PLLI2SP,
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_SAI1 |
        RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_RTC |
        RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_I2C1 |
        RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_USART1 |
        ...
        RCC_PERIPHCLK_UART8 | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_CLK48 |
        RCC_PERIPHCLK_SDMMC2 | RCC_PERIPHCLK_DFSDM1 |
        RCC_PERIPHCLK_DFSDM1_AUDIO;
#else
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_SAI1 |
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_UART7 | RCC_PERIPHCLK_UART8 | RCC_PERIPHCLK_SDMMC1 |
