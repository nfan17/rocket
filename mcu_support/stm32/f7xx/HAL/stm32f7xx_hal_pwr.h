...
#define PWR_PVD_MODE_IT_RISING_FALLING \
    ((uint32_t)0x00010003U) /*!< External Interrupt Mode with Rising/Falling edge trigger detection */
...
#define PWR_EXTI_LINE_PVD \
    ((uint32_t)           \
         EXTI_IMR_IM16) /*!< External interrupt line 16 Connected to the PVD EXTI Line */
/**
  * @}
  */
