...
#define I2C_FASTMODEPLUS_PB6 \
    (uint32_t)(0x00000004U | \
               I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB6 not supported   */
#define I2C_FASTMODEPLUS_PB7 \
    (uint32_t)(0x00000008U | \
               I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB7 not supported   */
...
#define I2C_FASTMODEPLUS_I2C1 \
    SYSCFG_PMC_I2C1_FMP /*!< Enable Fast Mode Plus on I2C1 pins */
#else
#define I2C_FASTMODEPLUS_I2C1 \
...
#define I2C_FASTMODEPLUS_I2C2 \
    SYSCFG_PMC_I2C2_FMP /*!< Enable Fast Mode Plus on I2C2 pins */
#else
#define I2C_FASTMODEPLUS_I2C2 \
...
#define I2C_FASTMODEPLUS_I2C3 \
    SYSCFG_PMC_I2C3_FMP /*!< Enable Fast Mode Plus on I2C3 pins */
#else
#define I2C_FASTMODEPLUS_I2C3 \
...
#define I2C_FASTMODEPLUS_I2C4 \
    SYSCFG_PMC_I2C4_FMP /*!< Enable Fast Mode Plus on I2C4 pins */
#else
#define I2C_FASTMODEPLUS_I2C4 \
